...
entry:
  %size0I.addr = alloca i32, align 4, addrspace(5)
  %0 = addrspacecast i32 addrspace(5)* %size0I.addr to i32*
  %alpha.coerce.elt = extractvalue %struct.tensile_complex %alpha.coerce, 0
  %alpha.coerce.elt12914 = extractvalue %struct.tensile_complex %alpha.coerce, 1
  %beta.coerce.elt = extractvalue %struct.tensile_complex %beta.coerce, 0
  %beta.coerce.elt12916 = extractvalue %struct.tensile_complex %beta.coerce, 1
  store volatile i32 %size0I, i32* %0, align 4, !tbaa !8
  ...
  %1 = load volatile i32, i32* %0, align 4, !tbaa !8
  %sub = add i32 %1, -1
  %cmp = icmp ugt i32 %add17, %sub
  br i1 %cmp, label %cond.true, label %cond.end

cond.true:                                        ; preds = %entry
  %2 = load volatile i32, i32* %0, align 4, !tbaa !8
  %sub47 = add i32 %2, -1
  br label %cond.end

cond.end:                                         ; preds = %cond.true, %entry
  %cond = phi i32 [ %sub47, %cond.true ], [ %add17, %entry ]
  %sub49 = add i32 %size1J, -1
  %cmp51 = icmp ugt i32 %add21, %sub49
  %sub49. = select i1 %cmp51, i32 %sub49, i32 %add21
  %cmp60 = icmp ugt i32 %add31, %sub49
  %cond66 = select i1 %cmp60, i32 %sub49, i32 %add31
  %cmp69 = icmp ugt i32 %add33, %sub49
  %sub67. = select i1 %cmp69, i32 %sub49, i32 %add33
  %mul77 = mul i32 %div22, %strideAL
  %mul79 = mul i32 %rem25, %strideAK
  %add78 = add i32 %cond, %mul79
  ...
  %add.ptr17912917 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %call
  %add.ptr179 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr17912917 to %struct.tensile_complex*
  %add.ptr18112918 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add162
  %add.ptr181 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr18112918 to %struct.tensile_complex*
  %add.ptr18312919 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add164
  %add.ptr183 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr18312919 to %struct.tensile_complex*
  %add.ptr18512920 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add166
  %add.ptr185 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr18512920 to %struct.tensile_complex*
  %add.ptr18712921 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add158
  %add.ptr187 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr18712921 to %struct.tensile_complex*
  %add.ptr18912922 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add169
  %add.ptr189 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr18912922 to %struct.tensile_complex*
  %add.ptr19112923 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add171
  %add.ptr191 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr19112923 to %struct.tensile_complex*
  %add.ptr19312924 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add174
  %add.ptr193 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr19312924 to %struct.tensile_complex*
  %add.ptr19512925 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add176
  %add.ptr195 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr19512925 to %struct.tensile_complex*
  %add.ptr19712926 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add178
  %add.ptr197 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr19712926 to %struct.tensile_complex*
  ...
  %add.ptr27712951 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add
  %add.ptr277 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr27712951 to %struct.tensile_complex*
  %add.ptr27912952 = getelementptr inbounds [640 x %struct.tensile_complex], [640 x %struct.tensile_complex] addrspace(3)* @_ZZ33Cijk_Ailk_Bjlk_ZB_MT32x48x8_SE_K1E11localMemory, i32 0, i32 %add9
  %add.ptr279 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr27912952 to %struct.tensile_complex*
  %cmp28017125 = icmp eq i32 %div244, 0
  br i1 %cmp28017125, label %while.end, label %while.body.lr.ph

while.body.lr.ph:                                 ; preds = %cond.end
  %conv293 = zext i32 %div244 to i64
  %3 = mul nuw i64 %mul145, %conv293
  %idx.neg = sub i64 0, %3
  %4 = mul nuw i64 %mul147, %conv293
  %idx.neg32516790 = sub i64 0, %4
  %5 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr17912917 to i64 addrspace(3)*
  ...
  %7 = bitcast double* %a_0_0_0_0.sroa.4.0..sroa_idx13935 to i64*
  %8 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr18112918 to i64 addrspace(3)*
  ...
  %10 = bitcast double* %a_0_0_1_0.sroa.4.0..sroa_idx13926 to i64*
  %11 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr18312919 to i64 addrspace(3)*
  ...
  %13 = bitcast double* %a_0_0_2_0.sroa.4.0..sroa_idx13917 to i64*
  %14 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr18512920 to i64 addrspace(3)*
  ...
  %16 = bitcast double* %a_0_0_3_0.sroa.4.0..sroa_idx13908 to i64*
  %17 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr18712921 to i64 addrspace(3)*
  ...
  %19 = bitcast double* %b_0_0_0_0.sroa.4.0..sroa_idx13899 to i64*
  %20 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr18912922 to i64 addrspace(3)*
  ...
  %22 = bitcast double* %b_1_0_0_0.sroa.4.0..sroa_idx13890 to i64*
  %23 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr19112923 to i64 addrspace(3)*
  ...
  %25 = bitcast double* %b_2_0_0_0.sroa.4.0..sroa_idx13881 to i64*
  %26 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr19312924 to i64 addrspace(3)*
  ...
  %28 = bitcast double* %b_0_0_1_0.sroa.4.0..sroa_idx13872 to i64*
  %29 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr19512925 to i64 addrspace(3)*
  ...
  %31 = bitcast double* %b_1_0_1_0.sroa.4.0..sroa_idx13863 to i64*
  %32 = bitcast %struct.tensile_complex addrspace(3)* %add.ptr19712926 to i64 addrspace(3)*
  %33 = addrspacecast i64 addrspace(3)* %32 to i64*
  ...
  %34 = bitcast double* %b_2_0_1_0.sroa.4.0..sroa_idx13854 to i64*
  ...
  %add.ptr39816988 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 32
  %add.ptr398 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr39816988 to %struct.tensile_complex*
  %add.ptr39916989 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 48
  %add.ptr399 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr39916989 to %struct.tensile_complex*
  ...
  %add.ptr140216990 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 64
  %add.ptr1402 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr140216990 to %struct.tensile_complex*
  %add.ptr140316991 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 96
  %add.ptr1403 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr140316991 to %struct.tensile_complex*
  ...
  %add.ptr240816992 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 96
  %add.ptr2408 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr240816992 to %struct.tensile_complex*
  %add.ptr240916993 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 144
  %add.ptr2409 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr240916993 to %struct.tensile_complex*
  ...
  %add.ptr341416994 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 128
  %add.ptr3414 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr341416994 to %struct.tensile_complex*
  %add.ptr341516995 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 192
  %add.ptr3415 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr341516995 to %struct.tensile_complex*
  ...
  %add.ptr442016996 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 160
  %add.ptr4420 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr442016996 to %struct.tensile_complex*
  %add.ptr442116997 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 240
  %add.ptr4421 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr442116997 to %struct.tensile_complex*
  ...
  %add.ptr542616998 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 192
  %add.ptr5426 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr542616998 to %struct.tensile_complex*
  %add.ptr542716999 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 288
  %add.ptr5427 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr542716999 to %struct.tensile_complex*
  ...
  %add.ptr643217000 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27712951, i32 224
  %add.ptr6432 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr643217000 to %struct.tensile_complex*
  %add.ptr643317001 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex addrspace(3)* %add.ptr27912952, i32 336
  %add.ptr6433 = addrspacecast %struct.tensile_complex addrspace(3)* %add.ptr643317001 to %struct.tensile_complex*
...
while.body:                                       ; preds = %while.body, %while.body.lr.ph
  %dec17160.in = phi i32 [ %div244, %while.body.lr.ph ], [ %dec17160, %while.body ]
  %rC.sroa.1669.017159 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8423, %while.body ]
  %35 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8403, %while.body ]
  %rC.sroa.1598.017158 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8382, %while.body ]
  %36 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8362, %while.body ]
  %rC.sroa.1527.017157 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8341, %while.body ]
  %37 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8321, %while.body ]
  %rC.sroa.1456.017156 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8300, %while.body ]
  %38 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8280, %while.body ]
  %rC.sroa.1385.017155 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8259, %while.body ]
  %39 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8239, %while.body ]
  %rC.sroa.1314.017154 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8218, %while.body ]
  %40 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8198, %while.body ]
  %rC.sroa.1243.017153 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8177, %while.body ]
  %41 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8157, %while.body ]
  %rC.sroa.1172.017152 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8136, %while.body ]
  %42 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8116, %while.body ]
  %rC.sroa.1101.017151 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8095, %while.body ]
  %43 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8075, %while.body ]
  %rC.sroa.1030.017150 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8054, %while.body ]
  %44 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8034, %while.body ]
  %rC.sroa.959.017149 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add8013, %while.body ]
  %45 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7993, %while.body ]
  %rC.sroa.888.017148 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7972, %while.body ]
  %46 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7952, %while.body ]
  %rC.sroa.817.017147 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7931, %while.body ]
  %47 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7911, %while.body ]
  %rC.sroa.746.017146 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7890, %while.body ]
  %48 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7870, %while.body ]
  %rC.sroa.675.017145 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7849, %while.body ]
  %49 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7829, %while.body ]
  %rC.sroa.604.017144 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7808, %while.body ]
  %50 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7788, %while.body ]
  %rC.sroa.533.017143 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7767, %while.body ]
  %51 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7747, %while.body ]
  %rC.sroa.462.017142 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7726, %while.body ]
  %52 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7706, %while.body ]
  %rC.sroa.391.017141 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7685, %while.body ]
  %53 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7665, %while.body ]
  %rC.sroa.320.017140 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7644, %while.body ]
  %54 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7624, %while.body ]
  %rC.sroa.249.017139 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7603, %while.body ]
  %55 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7583, %while.body ]
  %rC.sroa.178.017138 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7562, %while.body ]
  %56 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7542, %while.body ]
  %rC.sroa.107.017137 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7521, %while.body ]
  %57 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7501, %while.body ]
  %rC.sroa.36.017136 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7480, %while.body ]
  %58 = phi double [ 0.000000e+00, %while.body.lr.ph ], [ %add7460, %while.body ]
  %globalReadB_2_0_1_0.017135 = phi %struct.tensile_complex* [ %add.ptr274, %while.body.lr.ph ], [ %add.ptr36616881.add.ptr36016877, %while.body ]
  %globalReadB_1_0_1_0.017134 = phi %struct.tensile_complex* [ %add.ptr271, %while.body.lr.ph ], [ %add.ptr35816859.add.ptr35216855, %while.body ]
  %globalReadB_0_0_1_0.017133 = phi %struct.tensile_complex* [ %add.ptr268, %while.body.lr.ph ], [ %add.ptr35016839.add.ptr34416835, %while.body ]
  %globalReadB_2_0_0_0.017132 = phi %struct.tensile_complex* [ %add.ptr265, %while.body.lr.ph ], [ %add.ptr34216821.add.ptr33616817, %while.body ]
  %globalReadB_1_0_0_0.017131 = phi %struct.tensile_complex* [ %add.ptr262, %while.body.lr.ph ], [ %add.ptr33416805.add.ptr32816801, %while.body ]
  %globalReadB_0_0_0_0.017130 = phi %struct.tensile_complex* [ %add.ptr259, %while.body.lr.ph ], [ %add.ptr32616791.add.ptr32016787, %while.body ]
  %globalReadA_0_0_3_0.017129 = phi %struct.tensile_complex* [ %add.ptr256, %while.body.lr.ph ], [ %add.ptr31816779.add.ptr31216775, %while.body ]
  %globalReadA_0_0_2_0.017128 = phi %struct.tensile_complex* [ %add.ptr253, %while.body.lr.ph ], [ %add.ptr31016769.add.ptr30416765, %while.body ]
  %globalReadA_0_0_1_0.017127 = phi %struct.tensile_complex* [ %add.ptr250, %while.body.lr.ph ], [ %add.ptr30216761.add.ptr29616757, %while.body ]
  %globalReadA_0_0_0_0.017126 = phi %struct.tensile_complex* [ %add.ptr247, %while.body.lr.ph ], [ %add.ptr295.add.ptr291, %while.body ]
  %dec17160 = add nsw i32 %dec17160.in, -1
  %59 = bitcast %struct.tensile_complex* %globalReadA_0_0_0_0.017126 to i64*
  %a_0_0_0_0.sroa.0.0.copyload1393316968 = load i64, i64* %59, align 8
  %a_0_0_0_0.sroa.4.0..sroa_idx13937 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_0_0.017126, i64 0, i32 1
  %60 = bitcast double* %a_0_0_0_0.sroa.4.0..sroa_idx13937 to i64*
  %a_0_0_0_0.sroa.4.0.copyload1393816969 = load i64, i64* %60, align 8
  %61 = bitcast %struct.tensile_complex* %globalReadA_0_0_1_0.017127 to i64*
  %a_0_0_1_0.sroa.0.0.copyload1392416970 = load i64, i64* %61, align 8
  %a_0_0_1_0.sroa.4.0..sroa_idx13928 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_1_0.017127, i64 0, i32 1
  %62 = bitcast double* %a_0_0_1_0.sroa.4.0..sroa_idx13928 to i64*
  %a_0_0_1_0.sroa.4.0.copyload1392916971 = load i64, i64* %62, align 8
  %63 = bitcast %struct.tensile_complex* %globalReadA_0_0_2_0.017128 to i64*
  %a_0_0_2_0.sroa.0.0.copyload1391516972 = load i64, i64* %63, align 8
  %a_0_0_2_0.sroa.4.0..sroa_idx13919 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_2_0.017128, i64 0, i32 1
  %64 = bitcast double* %a_0_0_2_0.sroa.4.0..sroa_idx13919 to i64*
  %a_0_0_2_0.sroa.4.0.copyload1392016973 = load i64, i64* %64, align 8
  %65 = bitcast %struct.tensile_complex* %globalReadA_0_0_3_0.017129 to i64*
  %a_0_0_3_0.sroa.0.0.copyload1390616974 = load i64, i64* %65, align 8
  %a_0_0_3_0.sroa.4.0..sroa_idx13910 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_3_0.017129, i64 0, i32 1
  %66 = bitcast double* %a_0_0_3_0.sroa.4.0..sroa_idx13910 to i64*
  %a_0_0_3_0.sroa.4.0.copyload1391116975 = load i64, i64* %66, align 8
  %67 = bitcast %struct.tensile_complex* %globalReadB_0_0_0_0.017130 to i64*
  %b_0_0_0_0.sroa.0.0.copyload1389716976 = load i64, i64* %67, align 8
  %b_0_0_0_0.sroa.4.0..sroa_idx13901 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_0_0_0_0.017130, i64 0, i32 1
  %68 = bitcast double* %b_0_0_0_0.sroa.4.0..sroa_idx13901 to i64*
  %b_0_0_0_0.sroa.4.0.copyload1390216977 = load i64, i64* %68, align 8
  %69 = bitcast %struct.tensile_complex* %globalReadB_1_0_0_0.017131 to i64*
  %b_1_0_0_0.sroa.0.0.copyload1388816978 = load i64, i64* %69, align 8
  %b_1_0_0_0.sroa.4.0..sroa_idx13892 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_0_0.017131, i64 0, i32 1
  %70 = bitcast double* %b_1_0_0_0.sroa.4.0..sroa_idx13892 to i64*
  %b_1_0_0_0.sroa.4.0.copyload1389316979 = load i64, i64* %70, align 8
  %71 = bitcast %struct.tensile_complex* %globalReadB_2_0_0_0.017132 to i64*
  %b_2_0_0_0.sroa.0.0.copyload1387916980 = load i64, i64* %71, align 8
  %b_2_0_0_0.sroa.4.0..sroa_idx13883 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_0_0.017132, i64 0, i32 1
  %72 = bitcast double* %b_2_0_0_0.sroa.4.0..sroa_idx13883 to i64*
  %b_2_0_0_0.sroa.4.0.copyload1388416981 = load i64, i64* %72, align 8
  %73 = bitcast %struct.tensile_complex* %globalReadB_0_0_1_0.017133 to i64*
  %b_0_0_1_0.sroa.0.0.copyload1387016982 = load i64, i64* %73, align 8
  %b_0_0_1_0.sroa.4.0..sroa_idx13874 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_0_0_1_0.017133, i64 0, i32 1
  %74 = bitcast double* %b_0_0_1_0.sroa.4.0..sroa_idx13874 to i64*
  %b_0_0_1_0.sroa.4.0.copyload1387516983 = load i64, i64* %74, align 8
  %75 = bitcast %struct.tensile_complex* %globalReadB_1_0_1_0.017134 to i64*
  %b_1_0_1_0.sroa.0.0.copyload1386116984 = load i64, i64* %75, align 8
  %b_1_0_1_0.sroa.4.0..sroa_idx13865 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_1_0.017134, i64 0, i32 1
  %76 = bitcast double* %b_1_0_1_0.sroa.4.0..sroa_idx13865 to i64*
  %b_1_0_1_0.sroa.4.0.copyload1386616985 = load i64, i64* %76, align 8
  %77 = bitcast %struct.tensile_complex* %globalReadB_2_0_1_0.017135 to i64*
  %b_2_0_1_0.sroa.0.0.copyload1385216986 = load i64, i64* %77, align 8
  %b_2_0_1_0.sroa.4.0..sroa_idx13856 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_1_0.017135, i64 0, i32 1
  %78 = bitcast double* %b_2_0_1_0.sroa.4.0..sroa_idx13856 to i64*
  %b_2_0_1_0.sroa.4.0.copyload1385716987 = load i64, i64* %78, align 8
  %add.ptr291 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_0_0.017126, i64 %mul145
  %cmp292 = icmp eq i32 %dec17160, %shl
  %add.ptr295 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr291, i64 %idx.neg
  %add.ptr29616757 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_1_0.017127, i64 %mul145
  %add.ptr30216761 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr29616757, i64 %idx.neg
  %add.ptr30416765 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_2_0.017128, i64 %mul145
  %add.ptr31016769 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr30416765, i64 %idx.neg
  %add.ptr31216775 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadA_0_0_3_0.017129, i64 %mul145
  %add.ptr31816779 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr31216775, i64 %idx.neg
  %add.ptr32016787 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_0_0_0_0.017130, i64 %mul147
  %add.ptr32616791 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr32016787, i64 %idx.neg32516790
  %add.ptr32816801 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_0_0.017131, i64 %mul147
  %add.ptr33416805 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr32816801, i64 %idx.neg32516790
  %add.ptr33616817 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_0_0.017132, i64 %mul147
  %add.ptr34216821 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr33616817, i64 %idx.neg32516790
  %add.ptr34416835 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_0_0_1_0.017133, i64 %mul147
  %add.ptr35016839 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr34416835, i64 %idx.neg32516790
  %add.ptr35216855 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_1_0.017134, i64 %mul147
  %add.ptr35816859 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr35216855, i64 %idx.neg32516790
  %add.ptr36016877 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_1_0.017135, i64 %mul147
  %add.ptr36616881 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr36016877, i64 %idx.neg32516790
  %add.ptr35816859.add.ptr35216855 = select i1 %cmp292, %struct.tensile_complex* %add.ptr35816859, %struct.tensile_complex* %add.ptr35216855
  %add.ptr34216821.add.ptr33616817 = select i1 %cmp292, %struct.tensile_complex* %add.ptr34216821, %struct.tensile_complex* %add.ptr33616817
  %add.ptr32616791.add.ptr32016787 = select i1 %cmp292, %struct.tensile_complex* %add.ptr32616791, %struct.tensile_complex* %add.ptr32016787
  %add.ptr31016769.add.ptr30416765 = select i1 %cmp292, %struct.tensile_complex* %add.ptr31016769, %struct.tensile_complex* %add.ptr30416765
  %add.ptr295.add.ptr291 = select i1 %cmp292, %struct.tensile_complex* %add.ptr295, %struct.tensile_complex* %add.ptr291
  %add.ptr30216761.add.ptr29616757 = select i1 %cmp292, %struct.tensile_complex* %add.ptr30216761, %struct.tensile_complex* %add.ptr29616757
  %add.ptr31816779.add.ptr31216775 = select i1 %cmp292, %struct.tensile_complex* %add.ptr31816779, %struct.tensile_complex* %add.ptr31216775
  %add.ptr33416805.add.ptr32816801 = select i1 %cmp292, %struct.tensile_complex* %add.ptr33416805, %struct.tensile_complex* %add.ptr32816801
  %add.ptr35016839.add.ptr34416835 = select i1 %cmp292, %struct.tensile_complex* %add.ptr35016839, %struct.tensile_complex* %add.ptr34416835
  %add.ptr36616881.add.ptr36016877 = select i1 %cmp292, %struct.tensile_complex* %add.ptr36616881, %struct.tensile_complex* %add.ptr36016877
  tail call void @hc_barrier(i32 1) #10
  store i64 %a_0_0_0_0.sroa.0.0.copyload1393316968, i64* %6, align 8
  store i64 %a_0_0_0_0.sroa.4.0.copyload1393816969, i64* %7, align 8
  store i64 %a_0_0_1_0.sroa.0.0.copyload1392416970, i64* %9, align 8
  store i64 %a_0_0_1_0.sroa.4.0.copyload1392916971, i64* %10, align 8
  store i64 %a_0_0_2_0.sroa.0.0.copyload1391516972, i64* %12, align 8
  store i64 %a_0_0_2_0.sroa.4.0.copyload1392016973, i64* %13, align 8
  store i64 %a_0_0_3_0.sroa.0.0.copyload1390616974, i64* %15, align 8
  store i64 %a_0_0_3_0.sroa.4.0.copyload1391116975, i64* %16, align 8
  store i64 %b_0_0_0_0.sroa.0.0.copyload1389716976, i64* %18, align 8
  store i64 %b_0_0_0_0.sroa.4.0.copyload1390216977, i64* %19, align 8
  store i64 %b_1_0_0_0.sroa.0.0.copyload1388816978, i64* %21, align 8
  store i64 %b_1_0_0_0.sroa.4.0.copyload1389316979, i64* %22, align 8
  store i64 %b_2_0_0_0.sroa.0.0.copyload1387916980, i64* %24, align 8
  store i64 %b_2_0_0_0.sroa.4.0.copyload1388416981, i64* %25, align 8
  store i64 %b_0_0_1_0.sroa.0.0.copyload1387016982, i64* %27, align 8
  store i64 %b_0_0_1_0.sroa.4.0.copyload1387516983, i64* %28, align 8
  store i64 %b_1_0_1_0.sroa.0.0.copyload1386116984, i64* %30, align 8
  store i64 %b_1_0_1_0.sroa.4.0.copyload1386616985, i64* %31, align 8
  store i64 %b_2_0_1_0.sroa.0.0.copyload1385216986, i64* %33, align 8
  store i64 %b_2_0_1_0.sroa.4.0.copyload1385716987, i64* %34, align 8
  tail call void @hc_barrier(i32 1) #10
  ...
  %add406 = fadd double %58, %mul403
  %79 = fmul double %rA.sroa.117.0.copyload, %rB.sroa.54.0.copyload
  %add416 = fsub double %add406, %79
  %mul423 = fmul double %rA.sroa.0.0.copyload, %rB.sroa.54.0.copyload
  %add426 = fadd double %rC.sroa.36.017136, %mul423
  ...
  %add446 = fadd double %57, %mul443
  %80 = fmul double %rA.sroa.342.16.copyload14999, %rB.sroa.54.0.copyload
  %add457 = fsub double %add446, %80
  %mul464 = fmul double %rA.sroa.225.16.copyload14982, %rB.sroa.54.0.copyload
  %add467 = fadd double %rC.sroa.107.017137, %mul464
  ...
  %add487 = fadd double %56, %mul484
  %81 = fmul double %rA.sroa.567.32.copyload15232, %rB.sroa.54.0.copyload
  %add498 = fsub double %add487, %81
  %mul505 = fmul double %rA.sroa.450.32.copyload15215, %rB.sroa.54.0.copyload
  %add508 = fadd double %rC.sroa.178.017138, %mul505
  ...
  %add528 = fadd double %55, %mul525
  %82 = fmul double %rA.sroa.792.48.copyload15493, %rB.sroa.54.0.copyload
  %add539 = fsub double %add528, %82
  %mul546 = fmul double %rA.sroa.675.48.copyload15476, %rB.sroa.54.0.copyload
  %add549 = fadd double %rC.sroa.249.017139, %mul546
  ...
  %add569 = fadd double %54, %mul566
  %83 = fmul double %rA.sroa.117.0.copyload, %rB.sroa.144.16.copyload14114
  %add580 = fsub double %add569, %83
  %mul587 = fmul double %rA.sroa.0.0.copyload, %rB.sroa.144.16.copyload14114
  %add590 = fadd double %rC.sroa.320.017140, %mul587
  ...
  %add610 = fadd double %53, %mul607
  %84 = fmul double %rA.sroa.342.16.copyload14999, %rB.sroa.144.16.copyload14114
  %add621 = fsub double %add610, %84
  %mul628 = fmul double %rA.sroa.225.16.copyload14982, %rB.sroa.144.16.copyload14114
  %add631 = fadd double %rC.sroa.391.017141, %mul628
  ...
  %add651 = fadd double %52, %mul648
  %85 = fmul double %rA.sroa.567.32.copyload15232, %rB.sroa.144.16.copyload14114
  %add662 = fsub double %add651, %85
  %mul669 = fmul double %rA.sroa.450.32.copyload15215, %rB.sroa.144.16.copyload14114
  %add672 = fadd double %rC.sroa.462.017142, %mul669
  ...
  %add692 = fadd double %51, %mul689
  %86 = fmul double %rA.sroa.792.48.copyload15493, %rB.sroa.144.16.copyload14114
  %add703 = fsub double %add692, %86
  %mul710 = fmul double %rA.sroa.675.48.copyload15476, %rB.sroa.144.16.copyload14114
  %add713 = fadd double %rC.sroa.533.017143, %mul710
  ...
  %add733 = fadd double %50, %mul730
  %87 = fmul double %rA.sroa.117.0.copyload, %rB.sroa.234.32.copyload14232
  %add744 = fsub double %add733, %87
  %mul751 = fmul double %rA.sroa.0.0.copyload, %rB.sroa.234.32.copyload14232
  %add754 = fadd double %rC.sroa.604.017144, %mul751
  ...
  %add774 = fadd double %49, %mul771
  %88 = fmul double %rA.sroa.342.16.copyload14999, %rB.sroa.234.32.copyload14232
  %add785 = fsub double %add774, %88
  %mul792 = fmul double %rA.sroa.225.16.copyload14982, %rB.sroa.234.32.copyload14232
  %add795 = fadd double %rC.sroa.675.017145, %mul792
  ...
  %add815 = fadd double %48, %mul812
  %89 = fmul double %rA.sroa.567.32.copyload15232, %rB.sroa.234.32.copyload14232
  %add826 = fsub double %add815, %89
  %mul833 = fmul double %rA.sroa.450.32.copyload15215, %rB.sroa.234.32.copyload14232
  %add836 = fadd double %rC.sroa.746.017146, %mul833
  ...
  %add856 = fadd double %47, %mul853
  %90 = fmul double %rA.sroa.792.48.copyload15493, %rB.sroa.234.32.copyload14232
  %add867 = fsub double %add856, %90
  %mul874 = fmul double %rA.sroa.675.48.copyload15476, %rB.sroa.234.32.copyload14232
  %add877 = fadd double %rC.sroa.817.017147, %mul874
  ...
  %add897 = fadd double %46, %mul894
  %91 = fmul double %rA.sroa.117.0.copyload, %rB.sroa.324.48.copyload14338
  %add908 = fsub double %add897, %91
  %mul915 = fmul double %rA.sroa.0.0.copyload, %rB.sroa.324.48.copyload14338
  %add918 = fadd double %rC.sroa.888.017148, %mul915
  ...
  %add938 = fadd double %45, %mul935
  %92 = fmul double %rA.sroa.342.16.copyload14999, %rB.sroa.324.48.copyload14338
  %add949 = fsub double %add938, %92
  %mul956 = fmul double %rA.sroa.225.16.copyload14982, %rB.sroa.324.48.copyload14338
  %add959 = fadd double %rC.sroa.959.017149, %mul956
  ...
  %add979 = fadd double %44, %mul976
  %93 = fmul double %rA.sroa.567.32.copyload15232, %rB.sroa.324.48.copyload14338
  %add990 = fsub double %add979, %93
  %mul997 = fmul double %rA.sroa.450.32.copyload15215, %rB.sroa.324.48.copyload14338
  %add1000 = fadd double %rC.sroa.1030.017150, %mul997
  ...
  %add1020 = fadd double %43, %mul1017
  %94 = fmul double %rA.sroa.792.48.copyload15493, %rB.sroa.324.48.copyload14338
  %add1031 = fsub double %add1020, %94
  %mul1038 = fmul double %rA.sroa.675.48.copyload15476, %rB.sroa.324.48.copyload14338
  %add1041 = fadd double %rC.sroa.1101.017151, %mul1038
  ...
  %add1061 = fadd double %42, %mul1058
  %95 = fmul double %rA.sroa.117.0.copyload, %rB.sroa.414.64.copyload14464
  %add1072 = fsub double %add1061, %95
  %mul1079 = fmul double %rA.sroa.0.0.copyload, %rB.sroa.414.64.copyload14464
  %add1082 = fadd double %rC.sroa.1172.017152, %mul1079
  ...
  %add1102 = fadd double %41, %mul1099
  %96 = fmul double %rA.sroa.342.16.copyload14999, %rB.sroa.414.64.copyload14464
  %add1113 = fsub double %add1102, %96
  %mul1120 = fmul double %rA.sroa.225.16.copyload14982, %rB.sroa.414.64.copyload14464
  %add1123 = fadd double %rC.sroa.1243.017153, %mul1120
  ...
  %add1143 = fadd double %40, %mul1140
  %97 = fmul double %rA.sroa.567.32.copyload15232, %rB.sroa.414.64.copyload14464
  %add1154 = fsub double %add1143, %97
  %mul1161 = fmul double %rA.sroa.450.32.copyload15215, %rB.sroa.414.64.copyload14464
  %add1164 = fadd double %rC.sroa.1314.017154, %mul1161
  ...
  %add1184 = fadd double %39, %mul1181
  %98 = fmul double %rA.sroa.792.48.copyload15493, %rB.sroa.414.64.copyload14464
  %add1195 = fsub double %add1184, %98
  %mul1202 = fmul double %rA.sroa.675.48.copyload15476, %rB.sroa.414.64.copyload14464
  %add1205 = fadd double %rC.sroa.1385.017155, %mul1202
  ...
  %add1225 = fadd double %38, %mul1222
  %99 = fmul double %rA.sroa.117.0.copyload, %rB.sroa.504.80.copyload14562
  %add1236 = fsub double %add1225, %99
  %mul1243 = fmul double %rA.sroa.0.0.copyload, %rB.sroa.504.80.copyload14562
  %add1246 = fadd double %rC.sroa.1456.017156, %mul1243
  ...
  %add1266 = fadd double %37, %mul1263
  %100 = fmul double %rA.sroa.342.16.copyload14999, %rB.sroa.504.80.copyload14562
  %add1277 = fsub double %add1266, %100
  %mul1284 = fmul double %rA.sroa.225.16.copyload14982, %rB.sroa.504.80.copyload14562
  %add1287 = fadd double %rC.sroa.1527.017157, %mul1284
  ...
  %add1307 = fadd double %36, %mul1304
  %101 = fmul double %rA.sroa.567.32.copyload15232, %rB.sroa.504.80.copyload14562
  %add1318 = fsub double %add1307, %101
  %mul1325 = fmul double %rA.sroa.450.32.copyload15215, %rB.sroa.504.80.copyload14562
  %add1328 = fadd double %rC.sroa.1598.017158, %mul1325
  ...
  %add1348 = fadd double %35, %mul1345
  %102 = fmul double %rA.sroa.792.48.copyload15493, %rB.sroa.504.80.copyload14562
  %add1359 = fsub double %add1348, %102
  %mul1366 = fmul double %rA.sroa.675.48.copyload15476, %rB.sroa.504.80.copyload14562
  %add1369 = fadd double %rC.sroa.1669.017159, %mul1366
  ...
  %103 = fmul double %rA.sroa.117.0.copyload14749, %rB.sroa.54.0.copyload14005
  %add1422 = fsub double %add1411, %103
  ...
  %104 = fmul double %rA.sroa.342.16.copyload14985, %rB.sroa.54.0.copyload14005
  %add1463 = fsub double %add1452, %104
  ...
  %105 = fmul double %rA.sroa.567.32.copyload15238, %rB.sroa.54.0.copyload14005
  %add1504 = fsub double %add1493, %105
  ...
  %106 = fmul double %rA.sroa.792.48.copyload15491, %rB.sroa.54.0.copyload14005
  %add1545 = fsub double %add1534, %106
  ...
  %107 = fmul double %rA.sroa.117.0.copyload14749, %rB.sroa.144.16.copyload
  %add1586 = fsub double %add1575, %107
  ...
  %108 = fmul double %rA.sroa.342.16.copyload14985, %rB.sroa.144.16.copyload
  %add1627 = fsub double %add1616, %108
  ...
  %109 = fmul double %rA.sroa.567.32.copyload15238, %rB.sroa.144.16.copyload
  %add1668 = fsub double %add1657, %109
  ...
  %110 = fmul double %rA.sroa.792.48.copyload15491, %rB.sroa.144.16.copyload
  %add1709 = fsub double %add1698, %110
  ...
  %111 = fmul double %rA.sroa.117.0.copyload14749, %rB.sroa.234.32.copyload14234
  %add1750 = fsub double %add1739, %111
  ...
  %112 = fmul double %rA.sroa.342.16.copyload14985, %rB.sroa.234.32.copyload14234
  %add1791 = fsub double %add1780, %112
  ...
  %113 = fmul double %rA.sroa.567.32.copyload15238, %rB.sroa.234.32.copyload14234
  %add1832 = fsub double %add1821, %113
  ...
  %114 = fmul double %rA.sroa.792.48.copyload15491, %rB.sroa.234.32.copyload14234
  %add1873 = fsub double %add1862, %114
  ...
  %115 = fmul double %rA.sroa.117.0.copyload14749, %rB.sroa.324.48.copyload14340
  %add1914 = fsub double %add1903, %115
  ...
  %116 = fmul double %rA.sroa.342.16.copyload14985, %rB.sroa.324.48.copyload14340
  %add1955 = fsub double %add1944, %116
  ...
  %117 = fmul double %rA.sroa.567.32.copyload15238, %rB.sroa.324.48.copyload14340
  %add1996 = fsub double %add1985, %117
  ...
  %118 = fmul double %rA.sroa.792.48.copyload15491, %rB.sroa.324.48.copyload14340
  %add2037 = fsub double %add2026, %118
  ...
  %119 = fmul double %rA.sroa.117.0.copyload14749, %rB.sroa.414.64.copyload14462
  %add2078 = fsub double %add2067, %119
  ...
  %120 = fmul double %rA.sroa.342.16.copyload14985, %rB.sroa.414.64.copyload14462
  %add2119 = fsub double %add2108, %120
  ...
  %121 = fmul double %rA.sroa.567.32.copyload15238, %rB.sroa.414.64.copyload14462
  %add2160 = fsub double %add2149, %121
  ...
  %122 = fmul double %rA.sroa.792.48.copyload15491, %rB.sroa.414.64.copyload14462
  %add2201 = fsub double %add2190, %122
  ...
  %123 = fmul double %rA.sroa.117.0.copyload14749, %rB.sroa.504.80.copyload14564
  %add2242 = fsub double %add2231, %123
  ...
  %124 = fmul double %rA.sroa.342.16.copyload14985, %rB.sroa.504.80.copyload14564
  %add2283 = fsub double %add2272, %124
  ...
  %125 = fmul double %rA.sroa.567.32.copyload15238, %rB.sroa.504.80.copyload14564
  %add2324 = fsub double %add2313, %125
  ...
  %126 = fmul double %rA.sroa.792.48.copyload15491, %rB.sroa.504.80.copyload14564
  %add2365 = fsub double %add2354, %126
  ...
  %127 = fmul double %rA.sroa.117.0.copyload14747, %rB.sroa.54.0.copyload14007
  %add2428 = fsub double %add2417, %127
  ...
  %128 = fmul double %rA.sroa.342.16.copyload14987, %rB.sroa.54.0.copyload14007
  %add2469 = fsub double %add2458, %128
  ...
  %129 = fmul double %rA.sroa.567.32.copyload15236, %rB.sroa.54.0.copyload14007
  %add2510 = fsub double %add2499, %129
  ...
  %130 = fmul double %rA.sroa.792.48.copyload15489, %rB.sroa.54.0.copyload14007
  %add2551 = fsub double %add2540, %130
  ...
  %131 = fmul double %rA.sroa.117.0.copyload14747, %rB.sroa.144.16.copyload14116
  %add2592 = fsub double %add2581, %131
  ...
  %132 = fmul double %rA.sroa.342.16.copyload14987, %rB.sroa.144.16.copyload14116
  %add2633 = fsub double %add2622, %132
  ...
  %133 = fmul double %rA.sroa.567.32.copyload15236, %rB.sroa.144.16.copyload14116
  %add2674 = fsub double %add2663, %133
  ...
  %134 = fmul double %rA.sroa.792.48.copyload15489, %rB.sroa.144.16.copyload14116
  %add2715 = fsub double %add2704, %134
  ...
  %135 = fmul double %rA.sroa.117.0.copyload14747, %rB.sroa.234.32.copyload14236
  %add2756 = fsub double %add2745, %135
  ...
  %136 = fmul double %rA.sroa.342.16.copyload14987, %rB.sroa.234.32.copyload14236
  %add2797 = fsub double %add2786, %136
  ...
  %137 = fmul double %rA.sroa.567.32.copyload15236, %rB.sroa.234.32.copyload14236
  %add2838 = fsub double %add2827, %137
  ...
  %138 = fmul double %rA.sroa.792.48.copyload15489, %rB.sroa.234.32.copyload14236
  %add2879 = fsub double %add2868, %138
  ...
  %139 = fmul double %rA.sroa.117.0.copyload14747, %rB.sroa.324.48.copyload14342
  %add2920 = fsub double %add2909, %139
  ...
  %140 = fmul double %rA.sroa.342.16.copyload14987, %rB.sroa.324.48.copyload14342
  %add2961 = fsub double %add2950, %140
  ...
  %141 = fmul double %rA.sroa.567.32.copyload15236, %rB.sroa.324.48.copyload14342
  %add3002 = fsub double %add2991, %141
  ...
  %142 = fmul double %rA.sroa.792.48.copyload15489, %rB.sroa.324.48.copyload14342
  %add3043 = fsub double %add3032, %142
  ...
  %143 = fmul double %rA.sroa.117.0.copyload14747, %rB.sroa.414.64.copyload14460
  %add3084 = fsub double %add3073, %143
  ...
  %144 = fmul double %rA.sroa.342.16.copyload14987, %rB.sroa.414.64.copyload14460
  %add3125 = fsub double %add3114, %144
  ...
  %145 = fmul double %rA.sroa.567.32.copyload15236, %rB.sroa.414.64.copyload14460
  %add3166 = fsub double %add3155, %145
  ...
  %146 = fmul double %rA.sroa.792.48.copyload15489, %rB.sroa.414.64.copyload14460
  %add3207 = fsub double %add3196, %146
  ...
  %147 = fmul double %rA.sroa.117.0.copyload14747, %rB.sroa.504.80.copyload14566
  %add3248 = fsub double %add3237, %147
  ...
  %148 = fmul double %rA.sroa.342.16.copyload14987, %rB.sroa.504.80.copyload14566
  %add3289 = fsub double %add3278, %148
  ...
  %149 = fmul double %rA.sroa.567.32.copyload15236, %rB.sroa.504.80.copyload14566
  %add3330 = fsub double %add3319, %149
  ...
  %150 = fmul double %rA.sroa.792.48.copyload15489, %rB.sroa.504.80.copyload14566
  %add3371 = fsub double %add3360, %150
  ...
  %151 = fmul double %rA.sroa.117.0.copyload14745, %rB.sroa.54.0.copyload14011
  %add3434 = fsub double %add3423, %151
  ...
  %152 = fmul double %rA.sroa.342.16.copyload14989, %rB.sroa.54.0.copyload14011
  %add3475 = fsub double %add3464, %152
  ...
  %153 = fmul double %rA.sroa.567.32.copyload15234, %rB.sroa.54.0.copyload14011
  %add3516 = fsub double %add3505, %153
  ...
  %154 = fmul double %rA.sroa.792.48.copyload15487, %rB.sroa.54.0.copyload14011
  %add3557 = fsub double %add3546, %154
  ...
  %155 = fmul double %rA.sroa.117.0.copyload14745, %rB.sroa.144.16.copyload14118
  %add3598 = fsub double %add3587, %155
  ...
  %156 = fmul double %rA.sroa.342.16.copyload14989, %rB.sroa.144.16.copyload14118
  %add3639 = fsub double %add3628, %156
  ...
  %157 = fmul double %rA.sroa.567.32.copyload15234, %rB.sroa.144.16.copyload14118
  %add3680 = fsub double %add3669, %157
  ...
  %158 = fmul double %rA.sroa.792.48.copyload15487, %rB.sroa.144.16.copyload14118
  %add3721 = fsub double %add3710, %158
  ...
  %159 = fmul double %rA.sroa.117.0.copyload14745, %rB.sroa.234.32.copyload14240
  %add3762 = fsub double %add3751, %159
  ...
  %160 = fmul double %rA.sroa.342.16.copyload14989, %rB.sroa.234.32.copyload14240
  %add3803 = fsub double %add3792, %160
  ...
  %161 = fmul double %rA.sroa.567.32.copyload15234, %rB.sroa.234.32.copyload14240
  %add3844 = fsub double %add3833, %161
  ...
  %162 = fmul double %rA.sroa.792.48.copyload15487, %rB.sroa.234.32.copyload14240
  %add3885 = fsub double %add3874, %162
  ...
  %163 = fmul double %rA.sroa.117.0.copyload14745, %rB.sroa.324.48.copyload14344
  %add3926 = fsub double %add3915, %163
  ...
  %164 = fmul double %rA.sroa.342.16.copyload14989, %rB.sroa.324.48.copyload14344
  %add3967 = fsub double %add3956, %164
  ...
  %165 = fmul double %rA.sroa.567.32.copyload15234, %rB.sroa.324.48.copyload14344
  %add4008 = fsub double %add3997, %165
  ...
  %166 = fmul double %rA.sroa.792.48.copyload15487, %rB.sroa.324.48.copyload14344
  %add4049 = fsub double %add4038, %166
  ...
  %167 = fmul double %rA.sroa.117.0.copyload14745, %rB.sroa.414.64.copyload14458
  %add4090 = fsub double %add4079, %167
  ...
  %168 = fmul double %rA.sroa.342.16.copyload14989, %rB.sroa.414.64.copyload14458
  %add4131 = fsub double %add4120, %168
  ...
  %169 = fmul double %rA.sroa.567.32.copyload15234, %rB.sroa.414.64.copyload14458
  %add4172 = fsub double %add4161, %169
  ...
  %170 = fmul double %rA.sroa.792.48.copyload15487, %rB.sroa.414.64.copyload14458
  %add4213 = fsub double %add4202, %170
  ...
  %171 = fmul double %rA.sroa.117.0.copyload14745, %rB.sroa.504.80.copyload14568
  %add4254 = fsub double %add4243, %171
  ...
  %172 = fmul double %rA.sroa.342.16.copyload14989, %rB.sroa.504.80.copyload14568
  %add4295 = fsub double %add4284, %172
  ...
  %173 = fmul double %rA.sroa.567.32.copyload15234, %rB.sroa.504.80.copyload14568
  %add4336 = fsub double %add4325, %173
  ...
  %174 = fmul double %rA.sroa.792.48.copyload15487, %rB.sroa.504.80.copyload14568
  %add4377 = fsub double %add4366, %174
  ...
  %175 = fmul double %rA.sroa.117.0.copyload14743, %rB.sroa.54.0.copyload14013
  %add4440 = fsub double %add4429, %175
  ...
  %176 = fmul double %rA.sroa.342.16.copyload14993, %rB.sroa.54.0.copyload14013
  %add4481 = fsub double %add4470, %176
  ...
  %177 = fmul double %rA.sroa.567.32.copyload, %rB.sroa.54.0.copyload14013
  %add4522 = fsub double %add4511, %177
  ...
  %178 = fmul double %rA.sroa.792.48.copyload15485, %rB.sroa.54.0.copyload14013
  %add4563 = fsub double %add4552, %178
  ...
  %179 = fmul double %rA.sroa.117.0.copyload14743, %rB.sroa.144.16.copyload14120
  %add4604 = fsub double %add4593, %179
  ...
  %180 = fmul double %rA.sroa.342.16.copyload14993, %rB.sroa.144.16.copyload14120
  %add4645 = fsub double %add4634, %180
  ...
  %181 = fmul double %rA.sroa.567.32.copyload, %rB.sroa.144.16.copyload14120
  %add4686 = fsub double %add4675, %181
  ...
  %182 = fmul double %rA.sroa.792.48.copyload15485, %rB.sroa.144.16.copyload14120
  %add4727 = fsub double %add4716, %182
  ...
  %183 = fmul double %rA.sroa.117.0.copyload14743, %rB.sroa.234.32.copyload14238
  %add4768 = fsub double %add4757, %183
  ...
  %184 = fmul double %rA.sroa.342.16.copyload14993, %rB.sroa.234.32.copyload14238
  %add4809 = fsub double %add4798, %184
  ...
  %185 = fmul double %rA.sroa.567.32.copyload, %rB.sroa.234.32.copyload14238
  %add4850 = fsub double %add4839, %185
  ...
  %186 = fmul double %rA.sroa.792.48.copyload15485, %rB.sroa.234.32.copyload14238
  %add4891 = fsub double %add4880, %186
  ...
  %187 = fmul double %rA.sroa.117.0.copyload14743, %rB.sroa.324.48.copyload14346
  %add4932 = fsub double %add4921, %187
  ...
  %188 = fmul double %rA.sroa.342.16.copyload14993, %rB.sroa.324.48.copyload14346
  %add4973 = fsub double %add4962, %188
  ...
  %189 = fmul double %rA.sroa.567.32.copyload, %rB.sroa.324.48.copyload14346
  %add5014 = fsub double %add5003, %189
  ...
  %190 = fmul double %rA.sroa.792.48.copyload15485, %rB.sroa.324.48.copyload14346
  %add5055 = fsub double %add5044, %190
  ...
  %191 = fmul double %rA.sroa.117.0.copyload14743, %rB.sroa.414.64.copyload14456
  %add5096 = fsub double %add5085, %191
  ...
  %192 = fmul double %rA.sroa.342.16.copyload14993, %rB.sroa.414.64.copyload14456
  %add5137 = fsub double %add5126, %192
  ...
  %193 = fmul double %rA.sroa.567.32.copyload, %rB.sroa.414.64.copyload14456
  %add5178 = fsub double %add5167, %193
  ...
  %194 = fmul double %rA.sroa.792.48.copyload15485, %rB.sroa.414.64.copyload14456
  %add5219 = fsub double %add5208, %194
  ...
  %195 = fmul double %rA.sroa.117.0.copyload14743, %rB.sroa.504.80.copyload14570
  %add5260 = fsub double %add5249, %195
  ...
  %196 = fmul double %rA.sroa.342.16.copyload14993, %rB.sroa.504.80.copyload14570
  %add5301 = fsub double %add5290, %196
  ...
  %197 = fmul double %rA.sroa.567.32.copyload, %rB.sroa.504.80.copyload14570
  %add5342 = fsub double %add5331, %197
  ...
  %198 = fmul double %rA.sroa.792.48.copyload15485, %rB.sroa.504.80.copyload14570
  %add5383 = fsub double %add5372, %198
  ...
  %199 = fmul double %rA.sroa.117.0.copyload14741, %rB.sroa.54.0.copyload14015
  %add5446 = fsub double %add5435, %199
  ...
  %200 = fmul double %rA.sroa.342.16.copyload, %rB.sroa.54.0.copyload14015
  %add5487 = fsub double %add5476, %200
  ...
  %201 = fmul double %rA.sroa.567.32.copyload15246, %rB.sroa.54.0.copyload14015
  %add5528 = fsub double %add5517, %201
  ...
  %202 = fmul double %rA.sroa.792.48.copyload15483, %rB.sroa.54.0.copyload14015
  %add5569 = fsub double %add5558, %202
  ...
  %203 = fmul double %rA.sroa.117.0.copyload14741, %rB.sroa.144.16.copyload14122
  %add5610 = fsub double %add5599, %203
  ...
  %204 = fmul double %rA.sroa.342.16.copyload, %rB.sroa.144.16.copyload14122
  %add5651 = fsub double %add5640, %204
  ...
  %205 = fmul double %rA.sroa.567.32.copyload15246, %rB.sroa.144.16.copyload14122
  %add5692 = fsub double %add5681, %205
  ...
  %206 = fmul double %rA.sroa.792.48.copyload15483, %rB.sroa.144.16.copyload14122
  %add5733 = fsub double %add5722, %206
  ...
  %207 = fmul double %rA.sroa.117.0.copyload14741, %rB.sroa.234.32.copyload14230
  %add5774 = fsub double %add5763, %207
  ...
  %208 = fmul double %rA.sroa.342.16.copyload, %rB.sroa.234.32.copyload14230
  %add5815 = fsub double %add5804, %208
  ...
  %209 = fmul double %rA.sroa.567.32.copyload15246, %rB.sroa.234.32.copyload14230
  %add5856 = fsub double %add5845, %209
  ...
  %210 = fmul double %rA.sroa.792.48.copyload15483, %rB.sroa.234.32.copyload14230
  %add5897 = fsub double %add5886, %210
  ...
  %211 = fmul double %rA.sroa.117.0.copyload14741, %rB.sroa.324.48.copyload14348
  %add5938 = fsub double %add5927, %211
  ...
  %212 = fmul double %rA.sroa.342.16.copyload, %rB.sroa.324.48.copyload14348
  %add5979 = fsub double %add5968, %212
  ...
  %213 = fmul double %rA.sroa.567.32.copyload15246, %rB.sroa.324.48.copyload14348
  %add6020 = fsub double %add6009, %213
  ...
  %214 = fmul double %rA.sroa.792.48.copyload15483, %rB.sroa.324.48.copyload14348
  %add6061 = fsub double %add6050, %214
  ...
  %215 = fmul double %rA.sroa.117.0.copyload14741, %rB.sroa.414.64.copyload14454
  %add6102 = fsub double %add6091, %215
  ...
  %216 = fmul double %rA.sroa.342.16.copyload, %rB.sroa.414.64.copyload14454
  %add6143 = fsub double %add6132, %216
  ...
  %217 = fmul double %rA.sroa.567.32.copyload15246, %rB.sroa.414.64.copyload14454
  %add6184 = fsub double %add6173, %217
  ...
  %218 = fmul double %rA.sroa.792.48.copyload15483, %rB.sroa.414.64.copyload14454
  %add6225 = fsub double %add6214, %218
  ...
  %219 = fmul double %rA.sroa.117.0.copyload14741, %rB.sroa.504.80.copyload14572
  %add6266 = fsub double %add6255, %219
  ...
  %220 = fmul double %rA.sroa.342.16.copyload, %rB.sroa.504.80.copyload14572
  %add6307 = fsub double %add6296, %220
  ...
  %221 = fmul double %rA.sroa.567.32.copyload15246, %rB.sroa.504.80.copyload14572
  %add6348 = fsub double %add6337, %221
  ...
  %222 = fmul double %rA.sroa.792.48.copyload15483, %rB.sroa.504.80.copyload14572
  %add6389 = fsub double %add6378, %222
  ...
  %223 = fmul double %rA.sroa.117.0.copyload14739, %rB.sroa.54.0.copyload14001
  %add6452 = fsub double %add6441, %223
  ...
  %224 = fmul double %rA.sroa.342.16.copyload14997, %rB.sroa.54.0.copyload14001
  %add6493 = fsub double %add6482, %224
  ...
  %225 = fmul double %rA.sroa.567.32.copyload15244, %rB.sroa.54.0.copyload14001
  %add6534 = fsub double %add6523, %225
  ...
  %226 = fmul double %rA.sroa.792.48.copyload15481, %rB.sroa.54.0.copyload14001
  %add6575 = fsub double %add6564, %226
  ...
  %227 = fmul double %rA.sroa.117.0.copyload14739, %rB.sroa.144.16.copyload14126
  %add6616 = fsub double %add6605, %227
  ...
  %228 = fmul double %rA.sroa.342.16.copyload14997, %rB.sroa.144.16.copyload14126
  %add6657 = fsub double %add6646, %228
  ...
  %229 = fmul double %rA.sroa.567.32.copyload15244, %rB.sroa.144.16.copyload14126
  %add6698 = fsub double %add6687, %229
  ...
  %230 = fmul double %rA.sroa.792.48.copyload15481, %rB.sroa.144.16.copyload14126
  %add6739 = fsub double %add6728, %230
  ...
  %231 = fmul double %rA.sroa.117.0.copyload14739, %rB.sroa.234.32.copyload
  %add6780 = fsub double %add6769, %231
  ...
  %232 = fmul double %rA.sroa.342.16.copyload14997, %rB.sroa.234.32.copyload
  %add6821 = fsub double %add6810, %232
  ...
  %233 = fmul double %rA.sroa.567.32.copyload15244, %rB.sroa.234.32.copyload
  %add6862 = fsub double %add6851, %233
  ...
  %234 = fmul double %rA.sroa.792.48.copyload15481, %rB.sroa.234.32.copyload
  %add6903 = fsub double %add6892, %234
  ...
  %235 = fmul double %rA.sroa.117.0.copyload14739, %rB.sroa.324.48.copyload14350
  %add6944 = fsub double %add6933, %235
  ...
  %236 = fmul double %rA.sroa.342.16.copyload14997, %rB.sroa.324.48.copyload14350
  %add6985 = fsub double %add6974, %236
  ...
  %237 = fmul double %rA.sroa.567.32.copyload15244, %rB.sroa.324.48.copyload14350
  %add7026 = fsub double %add7015, %237
  ...
  %238 = fmul double %rA.sroa.792.48.copyload15481, %rB.sroa.324.48.copyload14350
  %add7067 = fsub double %add7056, %238
  ...
  %239 = fmul double %rA.sroa.117.0.copyload14739, %rB.sroa.414.64.copyload14452
  %add7108 = fsub double %add7097, %239
  ...
  %240 = fmul double %rA.sroa.342.16.copyload14997, %rB.sroa.414.64.copyload14452
  %add7149 = fsub double %add7138, %240
  ...
  %241 = fmul double %rA.sroa.567.32.copyload15244, %rB.sroa.414.64.copyload14452
  %add7190 = fsub double %add7179, %241
  ...
  %242 = fmul double %rA.sroa.792.48.copyload15481, %rB.sroa.414.64.copyload14452
  %add7231 = fsub double %add7220, %242
  ...
  %243 = fmul double %rA.sroa.117.0.copyload14739, %rB.sroa.504.80.copyload14574
  %add7272 = fsub double %add7261, %243
  ...
  %244 = fmul double %rA.sroa.342.16.copyload14997, %rB.sroa.504.80.copyload14574
  %add7313 = fsub double %add7302, %244
  ...
  %245 = fmul double %rA.sroa.567.32.copyload15244, %rB.sroa.504.80.copyload14574
  %add7354 = fsub double %add7343, %245
  ...
  %246 = fmul double %rA.sroa.792.48.copyload15481, %rB.sroa.504.80.copyload14574
  %add7395 = fsub double %add7384, %246
  ...
  %247 = fmul double %rA.sroa.117.0.copyload14737, %rB.sroa.54.0.copyload14003
  %add7460 = fsub double %add7449, %247
  ...
  %248 = fmul double %rA.sroa.342.16.copyload14995, %rB.sroa.54.0.copyload14003
  %add7501 = fsub double %add7490, %248
  ...
  %249 = fmul double %rA.sroa.567.32.copyload15242, %rB.sroa.54.0.copyload14003
  %add7542 = fsub double %add7531, %249
  ...
  %250 = fmul double %rA.sroa.792.48.copyload15479, %rB.sroa.54.0.copyload14003
  %add7583 = fsub double %add7572, %250
  ...
  %251 = fmul double %rA.sroa.117.0.copyload14737, %rB.sroa.144.16.copyload14124
  %add7624 = fsub double %add7613, %251
  ...
  %252 = fmul double %rA.sroa.342.16.copyload14995, %rB.sroa.144.16.copyload14124
  %add7665 = fsub double %add7654, %252
  ...
  %253 = fmul double %rA.sroa.567.32.copyload15242, %rB.sroa.144.16.copyload14124
  %add7706 = fsub double %add7695, %253
  ...
  %254 = fmul double %rA.sroa.792.48.copyload15479, %rB.sroa.144.16.copyload14124
  %add7747 = fsub double %add7736, %254
  ...
  %255 = fmul double %rA.sroa.117.0.copyload14737, %rB.sroa.234.32.copyload14228
  %add7788 = fsub double %add7777, %255
  ...
  %256 = fmul double %rA.sroa.342.16.copyload14995, %rB.sroa.234.32.copyload14228
  %add7829 = fsub double %add7818, %256
  ...
  %257 = fmul double %rA.sroa.567.32.copyload15242, %rB.sroa.234.32.copyload14228
  %add7870 = fsub double %add7859, %257
  ...
  %258 = fmul double %rA.sroa.792.48.copyload15479, %rB.sroa.234.32.copyload14228
  %add7911 = fsub double %add7900, %258
  ...
  %259 = fmul double %rA.sroa.117.0.copyload14737, %rB.sroa.324.48.copyload14352
  %add7952 = fsub double %add7941, %259
  ...
  %260 = fmul double %rA.sroa.342.16.copyload14995, %rB.sroa.324.48.copyload14352
  %add7993 = fsub double %add7982, %260
  ...
  %261 = fmul double %rA.sroa.567.32.copyload15242, %rB.sroa.324.48.copyload14352
  %add8034 = fsub double %add8023, %261
  ...
  %262 = fmul double %rA.sroa.792.48.copyload15479, %rB.sroa.324.48.copyload14352
  %add8075 = fsub double %add8064, %262
  ...
  %263 = fmul double %rA.sroa.117.0.copyload14737, %rB.sroa.414.64.copyload
  %add8116 = fsub double %add8105, %263
  ...
  %264 = fmul double %rA.sroa.342.16.copyload14995, %rB.sroa.414.64.copyload
  %add8157 = fsub double %add8146, %264
  ...
  %265 = fmul double %rA.sroa.567.32.copyload15242, %rB.sroa.414.64.copyload
  %add8198 = fsub double %add8187, %265
  ...
  %266 = fmul double %rA.sroa.792.48.copyload15479, %rB.sroa.414.64.copyload
  %add8239 = fsub double %add8228, %266
  ...
  %267 = fmul double %rA.sroa.117.0.copyload14737, %rB.sroa.504.80.copyload14576
  %add8280 = fsub double %add8269, %267
  ...
  %268 = fmul double %rA.sroa.342.16.copyload14995, %rB.sroa.504.80.copyload14576
  %add8321 = fsub double %add8310, %268
  ...
  %269 = fmul double %rA.sroa.567.32.copyload15242, %rB.sroa.504.80.copyload14576
  %add8362 = fsub double %add8351, %269
  ...
  %270 = fmul double %rA.sroa.792.48.copyload15479, %rB.sroa.504.80.copyload14576
  %add8403 = fsub double %add8392, %270
  ...
  %cmp280 = icmp eq i32 %dec17160, 0
  br i1 %cmp280, label %while.end, label %while.body

while.end:                                        ; preds = %while.body, %cond.end
  %globalReadA_0_0_0_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr247, %cond.end ], [ %add.ptr295.add.ptr291, %while.body ]
  %globalReadA_0_0_1_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr250, %cond.end ], [ %add.ptr30216761.add.ptr29616757, %while.body ]
  %globalReadA_0_0_2_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr253, %cond.end ], [ %add.ptr31016769.add.ptr30416765, %while.body ]
  %globalReadA_0_0_3_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr256, %cond.end ], [ %add.ptr31816779.add.ptr31216775, %while.body ]
  %globalReadB_0_0_0_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr259, %cond.end ], [ %add.ptr32616791.add.ptr32016787, %while.body ]
  %globalReadB_1_0_0_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr262, %cond.end ], [ %add.ptr33416805.add.ptr32816801, %while.body ]
  %globalReadB_2_0_0_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr265, %cond.end ], [ %add.ptr34216821.add.ptr33616817, %while.body ]
  %globalReadB_0_0_1_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr268, %cond.end ], [ %add.ptr35016839.add.ptr34416835, %while.body ]
  %globalReadB_1_0_1_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr271, %cond.end ], [ %add.ptr35816859.add.ptr35216855, %while.body ]
  %globalReadB_2_0_1_0.0.lcssa = phi %struct.tensile_complex* [ %add.ptr274, %cond.end ], [ %add.ptr36616881.add.ptr36016877, %while.body ]
  %.lcssa17048 = phi double [ 0.000000e+00, %cond.end ], [ %add7460, %while.body ]
  %rC.sroa.36.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7480, %while.body ]
  %.lcssa17047 = phi double [ 0.000000e+00, %cond.end ], [ %add7501, %while.body ]
  %rC.sroa.107.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7521, %while.body ]
  %.lcssa17046 = phi double [ 0.000000e+00, %cond.end ], [ %add7542, %while.body ]
  %rC.sroa.178.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7562, %while.body ]
  %.lcssa17045 = phi double [ 0.000000e+00, %cond.end ], [ %add7583, %while.body ]
  %rC.sroa.249.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7603, %while.body ]
  %.lcssa17044 = phi double [ 0.000000e+00, %cond.end ], [ %add7624, %while.body ]
  %rC.sroa.320.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7644, %while.body ]
  %.lcssa17043 = phi double [ 0.000000e+00, %cond.end ], [ %add7665, %while.body ]
  %rC.sroa.391.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7685, %while.body ]
  %.lcssa17042 = phi double [ 0.000000e+00, %cond.end ], [ %add7706, %while.body ]
  %rC.sroa.462.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7726, %while.body ]
  %.lcssa17041 = phi double [ 0.000000e+00, %cond.end ], [ %add7747, %while.body ]
  %rC.sroa.533.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7767, %while.body ]
  %.lcssa17040 = phi double [ 0.000000e+00, %cond.end ], [ %add7788, %while.body ]
  %rC.sroa.604.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7808, %while.body ]
  %.lcssa17039 = phi double [ 0.000000e+00, %cond.end ], [ %add7829, %while.body ]
  %rC.sroa.675.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7849, %while.body ]
  %.lcssa17038 = phi double [ 0.000000e+00, %cond.end ], [ %add7870, %while.body ]
  %rC.sroa.746.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7890, %while.body ]
  %.lcssa17037 = phi double [ 0.000000e+00, %cond.end ], [ %add7911, %while.body ]
  %rC.sroa.817.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7931, %while.body ]
  %.lcssa17036 = phi double [ 0.000000e+00, %cond.end ], [ %add7952, %while.body ]
  %rC.sroa.888.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add7972, %while.body ]
  %.lcssa17035 = phi double [ 0.000000e+00, %cond.end ], [ %add7993, %while.body ]
  %rC.sroa.959.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8013, %while.body ]
  %.lcssa17034 = phi double [ 0.000000e+00, %cond.end ], [ %add8034, %while.body ]
  %rC.sroa.1030.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8054, %while.body ]
  %.lcssa17033 = phi double [ 0.000000e+00, %cond.end ], [ %add8075, %while.body ]
  %rC.sroa.1101.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8095, %while.body ]
  %.lcssa17032 = phi double [ 0.000000e+00, %cond.end ], [ %add8116, %while.body ]
  %rC.sroa.1172.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8136, %while.body ]
  %.lcssa17031 = phi double [ 0.000000e+00, %cond.end ], [ %add8157, %while.body ]
  %rC.sroa.1243.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8177, %while.body ]
  %.lcssa17030 = phi double [ 0.000000e+00, %cond.end ], [ %add8198, %while.body ]
  %rC.sroa.1314.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8218, %while.body ]
  %.lcssa17029 = phi double [ 0.000000e+00, %cond.end ], [ %add8239, %while.body ]
  %rC.sroa.1385.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8259, %while.body ]
  %.lcssa17028 = phi double [ 0.000000e+00, %cond.end ], [ %add8280, %while.body ]
  %rC.sroa.1456.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8300, %while.body ]
  %.lcssa17027 = phi double [ 0.000000e+00, %cond.end ], [ %add8321, %while.body ]
  %rC.sroa.1527.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8341, %while.body ]
  %.lcssa17026 = phi double [ 0.000000e+00, %cond.end ], [ %add8362, %while.body ]
  %rC.sroa.1598.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8382, %while.body ]
  %.lcssa17025 = phi double [ 0.000000e+00, %cond.end ], [ %add8403, %while.body ]
  %rC.sroa.1669.0.lcssa = phi double [ 0.000000e+00, %cond.end ], [ %add8423, %while.body ]
...
cond.false8533:                                   ; preds = %cond.end8511
  ...
  %ref.tmp8520.sroa.0.0..sroa_cast16901 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_0_0.0.lcssa, i64 %mul8453, i32 0
  %ref.tmp8520.sroa.3.0..sroa_idx16902 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_0_0.0.lcssa, i64 %mul8453, i32 1
  %ref.tmp8520.sroa.0.0.copyload = load double, double* %ref.tmp8520.sroa.0.0..sroa_cast16901, align 8
  %ref.tmp8520.sroa.3.0.copyload = load double, double* %ref.tmp8520.sroa.3.0..sroa_idx16902, align 8
  %ref.tmp8528.sroa.0.0..sroa_cast16910 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_0_0.0.lcssa, i64 %mul8453, i32 0
  %ref.tmp8528.sroa.3.0..sroa_idx16911 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_0_0.0.lcssa, i64 %mul8453, i32 1
  %ref.tmp8528.sroa.0.0.copyload = load double, double* %ref.tmp8528.sroa.0.0..sroa_cast16910, align 8
  %ref.tmp8528.sroa.3.0.copyload = load double, double* %ref.tmp8528.sroa.3.0..sroa_idx16911, align 8
  br label %cond.end8535

cond.end8535:                                     ; preds = %cond.false8533, %cond.end8511
  %ref.tmp8520.sroa.0.016919 = phi double [ %ref.tmp8520.sroa.0.0.copyload, %cond.false8533 ], [ 0.000000e+00, %cond.end8511 ]
  %ref.tmp8520.sroa.3.016917 = phi double [ %ref.tmp8520.sroa.3.0.copyload, %cond.false8533 ], [ 0.000000e+00, %cond.end8511 ]
  %ref.tmp8512.sroa.3.01690416915 = phi double [ %ref.tmp8512.sroa.3.0.copyload, %cond.false8533 ], [ 0.000000e+00, %cond.end8511 ]
  %ref.tmp8512.sroa.0.01690616913 = phi double [ %ref.tmp8512.sroa.0.0.copyload, %cond.false8533 ], [ 0.000000e+00, %cond.end8511 ]
...
cond.false8557:                                   ; preds = %cond.end8535
  ...
  %ref.tmp8544.sroa.0.0..sroa_cast16923 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_1_0.0.lcssa, i64 %mul8453, i32 0
  %ref.tmp8544.sroa.3.0..sroa_idx16924 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_1_0_1_0.0.lcssa, i64 %mul8453, i32 1
  %ref.tmp8544.sroa.0.0.copyload = load double, double* %ref.tmp8544.sroa.0.0..sroa_cast16923, align 8
  %ref.tmp8544.sroa.3.0.copyload = load double, double* %ref.tmp8544.sroa.3.0..sroa_idx16924, align 8
  %ref.tmp8552.sroa.0.0..sroa_cast16932 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_1_0.0.lcssa, i64 %mul8453, i32 0
  %ref.tmp8552.sroa.3.0..sroa_idx16933 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %globalReadB_2_0_1_0.0.lcssa, i64 %mul8453, i32 1
  %ref.tmp8552.sroa.0.0.copyload = load double, double* %ref.tmp8552.sroa.0.0..sroa_cast16932, align 8
  %ref.tmp8552.sroa.3.0.copyload = load double, double* %ref.tmp8552.sroa.3.0..sroa_idx16933, align 8
  br label %cond.end8559

cond.end8559:                                     ; preds = %cond.false8557, %cond.end8535
  %ref.tmp8544.sroa.0.016941 = phi double [ %ref.tmp8544.sroa.0.0.copyload, %cond.false8557 ], [ 0.000000e+00, %cond.end8535 ]
  %ref.tmp8544.sroa.3.016939 = phi double [ %ref.tmp8544.sroa.3.0.copyload, %cond.false8557 ], [ 0.000000e+00, %cond.end8535 ]
  %ref.tmp8536.sroa.3.01692616937 = phi double [ %ref.tmp8536.sroa.3.0.copyload, %cond.false8557 ], [ 0.000000e+00, %cond.end8535 ]
  %ref.tmp8536.sroa.0.01692816935 = phi double [ %ref.tmp8536.sroa.0.0.copyload, %cond.false8557 ], [ 0.000000e+00, %cond.end8535 ]
  ...
  store double %ref.tmp8512.sroa.0.01690616913, double* %b_0_0_0_0.sroa.0.0..sroa_idx, align 8
  ...
  store double %ref.tmp8512.sroa.3.01690416915, double* %b_0_0_0_0.sroa.4.0..sroa_idx13898, align 8
  %b_1_0_0_0.sroa.0.0..sroa_idx = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr189, i64 0, i32 0
  store double %ref.tmp8520.sroa.0.016919, double* %b_1_0_0_0.sroa.0.0..sroa_idx, align 8
  ...
  store double %ref.tmp8520.sroa.3.016917, double* %b_1_0_0_0.sroa.4.0..sroa_idx13889, align 8
  ...
  store double %ref.tmp8536.sroa.0.01692816935, double* %b_0_0_1_0.sroa.0.0..sroa_idx, align 8
  ...
  store double %ref.tmp8536.sroa.3.01692616937, double* %b_0_0_1_0.sroa.4.0..sroa_idx13871, align 8
  %b_1_0_1_0.sroa.0.0..sroa_idx = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %add.ptr195, i64 0, i32 0
  store double %ref.tmp8544.sroa.0.016941, double* %b_1_0_1_0.sroa.0.0..sroa_idx, align 8
  ...
  store double %ref.tmp8544.sroa.3.016939, double* %b_1_0_1_0.sroa.4.0..sroa_idx13862, align 8
  ...
  tail call void @hc_barrier(i32 1) #10
  %cmp859217049 = icmp eq i32 %rem8426, 0
  br i1 %cmp859217049, label %while.end9600, label %while.body8593

while.body8593:                                   ; preds = %while.body8593, %cond.end8559
  %rC.sroa.1669.117076 = phi double [ %add9597, %while.body8593 ], [ %rC.sroa.1669.0.lcssa, %cond.end8559 ]
  %271 = phi double [ %add9577, %while.body8593 ], [ %.lcssa17025, %cond.end8559 ]
  %rC.sroa.1598.117075 = phi double [ %add9556, %while.body8593 ], [ %rC.sroa.1598.0.lcssa, %cond.end8559 ]
  %272 = phi double [ %add9536, %while.body8593 ], [ %.lcssa17026, %cond.end8559 ]
  %rC.sroa.1527.117074 = phi double [ %add9515, %while.body8593 ], [ %rC.sroa.1527.0.lcssa, %cond.end8559 ]
  %273 = phi double [ %add9495, %while.body8593 ], [ %.lcssa17027, %cond.end8559 ]
  %rC.sroa.1456.117073 = phi double [ %add9474, %while.body8593 ], [ %rC.sroa.1456.0.lcssa, %cond.end8559 ]
  %274 = phi double [ %add9454, %while.body8593 ], [ %.lcssa17028, %cond.end8559 ]
  %rC.sroa.1385.117072 = phi double [ %add9433, %while.body8593 ], [ %rC.sroa.1385.0.lcssa, %cond.end8559 ]
  %275 = phi double [ %add9413, %while.body8593 ], [ %.lcssa17029, %cond.end8559 ]
  %rC.sroa.1314.117071 = phi double [ %add9392, %while.body8593 ], [ %rC.sroa.1314.0.lcssa, %cond.end8559 ]
  %276 = phi double [ %add9372, %while.body8593 ], [ %.lcssa17030, %cond.end8559 ]
  %rC.sroa.1243.117070 = phi double [ %add9351, %while.body8593 ], [ %rC.sroa.1243.0.lcssa, %cond.end8559 ]
  %277 = phi double [ %add9331, %while.body8593 ], [ %.lcssa17031, %cond.end8559 ]
  %rC.sroa.1172.117069 = phi double [ %add9310, %while.body8593 ], [ %rC.sroa.1172.0.lcssa, %cond.end8559 ]
  %278 = phi double [ %add9290, %while.body8593 ], [ %.lcssa17032, %cond.end8559 ]
  %rC.sroa.1101.117068 = phi double [ %add9269, %while.body8593 ], [ %rC.sroa.1101.0.lcssa, %cond.end8559 ]
  %279 = phi double [ %add9249, %while.body8593 ], [ %.lcssa17033, %cond.end8559 ]
  %rC.sroa.1030.117067 = phi double [ %add9228, %while.body8593 ], [ %rC.sroa.1030.0.lcssa, %cond.end8559 ]
  %280 = phi double [ %add9208, %while.body8593 ], [ %.lcssa17034, %cond.end8559 ]
  %rC.sroa.959.117066 = phi double [ %add9187, %while.body8593 ], [ %rC.sroa.959.0.lcssa, %cond.end8559 ]
  %281 = phi double [ %add9167, %while.body8593 ], [ %.lcssa17035, %cond.end8559 ]
  %rC.sroa.888.117065 = phi double [ %add9146, %while.body8593 ], [ %rC.sroa.888.0.lcssa, %cond.end8559 ]
  %282 = phi double [ %add9126, %while.body8593 ], [ %.lcssa17036, %cond.end8559 ]
  %rC.sroa.817.117064 = phi double [ %add9105, %while.body8593 ], [ %rC.sroa.817.0.lcssa, %cond.end8559 ]
  %283 = phi double [ %add9085, %while.body8593 ], [ %.lcssa17037, %cond.end8559 ]
  %rC.sroa.746.117063 = phi double [ %add9064, %while.body8593 ], [ %rC.sroa.746.0.lcssa, %cond.end8559 ]
  %284 = phi double [ %add9044, %while.body8593 ], [ %.lcssa17038, %cond.end8559 ]
  %rC.sroa.675.117062 = phi double [ %add9023, %while.body8593 ], [ %rC.sroa.675.0.lcssa, %cond.end8559 ]
  %285 = phi double [ %add9003, %while.body8593 ], [ %.lcssa17039, %cond.end8559 ]
  %rC.sroa.604.117061 = phi double [ %add8982, %while.body8593 ], [ %rC.sroa.604.0.lcssa, %cond.end8559 ]
  %286 = phi double [ %add8962, %while.body8593 ], [ %.lcssa17040, %cond.end8559 ]
  %rC.sroa.533.117060 = phi double [ %add8941, %while.body8593 ], [ %rC.sroa.533.0.lcssa, %cond.end8559 ]
  %287 = phi double [ %add8921, %while.body8593 ], [ %.lcssa17041, %cond.end8559 ]
  %rC.sroa.462.117059 = phi double [ %add8900, %while.body8593 ], [ %rC.sroa.462.0.lcssa, %cond.end8559 ]
  %288 = phi double [ %add8880, %while.body8593 ], [ %.lcssa17042, %cond.end8559 ]
  %rC.sroa.391.117058 = phi double [ %add8859, %while.body8593 ], [ %rC.sroa.391.0.lcssa, %cond.end8559 ]
  %289 = phi double [ %add8839, %while.body8593 ], [ %.lcssa17043, %cond.end8559 ]
  %rC.sroa.320.117057 = phi double [ %add8818, %while.body8593 ], [ %rC.sroa.320.0.lcssa, %cond.end8559 ]
  %290 = phi double [ %add8798, %while.body8593 ], [ %.lcssa17044, %cond.end8559 ]
  %rC.sroa.249.117056 = phi double [ %add8777, %while.body8593 ], [ %rC.sroa.249.0.lcssa, %cond.end8559 ]
  %291 = phi double [ %add8757, %while.body8593 ], [ %.lcssa17045, %cond.end8559 ]
  %rC.sroa.178.117055 = phi double [ %add8736, %while.body8593 ], [ %rC.sroa.178.0.lcssa, %cond.end8559 ]
  %292 = phi double [ %add8716, %while.body8593 ], [ %.lcssa17046, %cond.end8559 ]
  %rC.sroa.107.117054 = phi double [ %add8695, %while.body8593 ], [ %rC.sroa.107.0.lcssa, %cond.end8559 ]
  %293 = phi double [ %add8675, %while.body8593 ], [ %.lcssa17047, %cond.end8559 ]
  %rC.sroa.36.117053 = phi double [ %add8654, %while.body8593 ], [ %rC.sroa.36.0.lcssa, %cond.end8559 ]
  %294 = phi double [ %add8634, %while.body8593 ], [ %.lcssa17048, %cond.end8559 ]
  %numIterL.117052 = phi i32 [ %dec8591, %while.body8593 ], [ %rem8426, %cond.end8559 ]
  %localReadA.117051 = phi %struct.tensile_complex* [ %add.ptr8614, %while.body8593 ], [ %add.ptr277, %cond.end8559 ]
  %localReadB.117050 = phi %struct.tensile_complex* [ %add.ptr8615, %while.body8593 ], [ %add.ptr279, %cond.end8559 ]
  %dec8591 = add nsw i32 %numIterL.117052, -1
  %rA.sroa.0.0..sroa_idx14733 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 0, i32 0
  %rA.sroa.0.0.copyload14734 = load double, double* %rA.sroa.0.0..sroa_idx14733, align 8
  %rA.sroa.117.0..sroa_idx14750 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 0, i32 1
  %rA.sroa.117.0.copyload14751 = load double, double* %rA.sroa.117.0..sroa_idx14750, align 8
  %rA.sroa.225.16.arrayidx8596.sroa_idx14973 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 8, i32 0
  %rA.sroa.225.16.copyload14974 = load double, double* %rA.sroa.225.16.arrayidx8596.sroa_idx14973, align 8
  %rA.sroa.342.16.arrayidx8596.sroa_idx14990 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 8, i32 1
  %rA.sroa.342.16.copyload14991 = load double, double* %rA.sroa.342.16.arrayidx8596.sroa_idx14990, align 8
  %rA.sroa.450.32..sroa_idx15222 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 16, i32 0
  %rA.sroa.450.32.copyload15223 = load double, double* %rA.sroa.450.32..sroa_idx15222, align 8
  %rA.sroa.567.32..sroa_idx15239 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 16, i32 1
  %rA.sroa.567.32.copyload15240 = load double, double* %rA.sroa.567.32..sroa_idx15239, align 8
  %rA.sroa.675.48..sroa_idx = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 24, i32 0
  %rA.sroa.675.48.copyload = load double, double* %rA.sroa.675.48..sroa_idx, align 8
  %rA.sroa.792.48..sroa_idx15477 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 24, i32 1
  %rA.sroa.792.48.copyload = load double, double* %rA.sroa.792.48..sroa_idx15477, align 8
  %rB.sroa.0.0..sroa_idx13991 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 0, i32 0
  %rB.sroa.0.0.copyload13992 = load double, double* %rB.sroa.0.0..sroa_idx13991, align 8
  %rB.sroa.54.0..sroa_idx14008 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 0, i32 1
  %rB.sroa.54.0.copyload14009 = load double, double* %rB.sroa.54.0..sroa_idx14008, align 8
  %rB.sroa.90.16.arrayidx8604.sroa_idx14110 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 8, i32 0
  %rB.sroa.90.16.copyload14111 = load double, double* %rB.sroa.90.16.arrayidx8604.sroa_idx14110, align 8
  %rB.sroa.144.16.arrayidx8604.sroa_idx14127 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 8, i32 1
  %rB.sroa.144.16.copyload14128 = load double, double* %rB.sroa.144.16.arrayidx8604.sroa_idx14127, align 8
  %rB.sroa.180.32..sroa_idx = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 16, i32 0
  %rB.sroa.180.32.copyload14209 = load double, double* %rB.sroa.180.32..sroa_idx, align 8
  %rB.sroa.234.32..sroa_idx14225 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 16, i32 1
  %rB.sroa.234.32.copyload14226 = load double, double* %rB.sroa.234.32..sroa_idx14225, align 8
  %rB.sroa.270.48..sroa_idx = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 24, i32 0
  %rB.sroa.270.48.copyload = load double, double* %rB.sroa.270.48..sroa_idx, align 8
  %rB.sroa.324.48..sroa_idx14336 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 24, i32 1
  %rB.sroa.324.48.copyload = load double, double* %rB.sroa.324.48..sroa_idx14336, align 8
  %rB.sroa.360.64..sroa_idx14432 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 32, i32 0
  %rB.sroa.360.64.copyload14433 = load double, double* %rB.sroa.360.64..sroa_idx14432, align 8
  %rB.sroa.414.64..sroa_idx14449 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 32, i32 1
  %rB.sroa.414.64.copyload14450 = load double, double* %rB.sroa.414.64..sroa_idx14449, align 8
  %rB.sroa.450.80..sroa_idx = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 40, i32 0
  %rB.sroa.450.80.copyload = load double, double* %rB.sroa.450.80..sroa_idx, align 8
  %rB.sroa.504.80..sroa_idx14560 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 40, i32 1
  %rB.sroa.504.80.copyload = load double, double* %rB.sroa.504.80..sroa_idx14560, align 8
  %add.ptr8614 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadA.117051, i64 32
  %add.ptr8615 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %localReadB.117050, i64 48
  %mul8620 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.0.0.copyload13992
  %add8623 = fadd double %294, %mul8620
  %295 = fmul double %rA.sroa.117.0.copyload14751, %rB.sroa.54.0.copyload14009
  %add8634 = fsub double %add8623, %295
  %mul8641 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.54.0.copyload14009
  %add8644 = fadd double %rC.sroa.36.117053, %mul8641
  ...
  %add8664 = fadd double %293, %mul8661
  %296 = fmul double %rA.sroa.342.16.copyload14991, %rB.sroa.54.0.copyload14009
  %add8675 = fsub double %add8664, %296
  %mul8682 = fmul double %rA.sroa.225.16.copyload14974, %rB.sroa.54.0.copyload14009
  %add8685 = fadd double %rC.sroa.107.117054, %mul8682
  ...
  %add8705 = fadd double %292, %mul8702
  %297 = fmul double %rA.sroa.567.32.copyload15240, %rB.sroa.54.0.copyload14009
  %add8716 = fsub double %add8705, %297
  %mul8723 = fmul double %rA.sroa.450.32.copyload15223, %rB.sroa.54.0.copyload14009
  %add8726 = fadd double %rC.sroa.178.117055, %mul8723
  ...
  %add8746 = fadd double %291, %mul8743
  %298 = fmul double %rA.sroa.792.48.copyload, %rB.sroa.54.0.copyload14009
  %add8757 = fsub double %add8746, %298
  %mul8764 = fmul double %rA.sroa.675.48.copyload, %rB.sroa.54.0.copyload14009
  %add8767 = fadd double %rC.sroa.249.117056, %mul8764
  ...
  %add8787 = fadd double %290, %mul8784
  %299 = fmul double %rA.sroa.117.0.copyload14751, %rB.sroa.144.16.copyload14128
  %add8798 = fsub double %add8787, %299
  %mul8805 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.144.16.copyload14128
  %add8808 = fadd double %rC.sroa.320.117057, %mul8805
  ...
  %add8828 = fadd double %289, %mul8825
  %300 = fmul double %rA.sroa.342.16.copyload14991, %rB.sroa.144.16.copyload14128
  %add8839 = fsub double %add8828, %300
  %mul8846 = fmul double %rA.sroa.225.16.copyload14974, %rB.sroa.144.16.copyload14128
  %add8849 = fadd double %rC.sroa.391.117058, %mul8846
  ...
  %add8869 = fadd double %288, %mul8866
  %301 = fmul double %rA.sroa.567.32.copyload15240, %rB.sroa.144.16.copyload14128
  %add8880 = fsub double %add8869, %301
  %mul8887 = fmul double %rA.sroa.450.32.copyload15223, %rB.sroa.144.16.copyload14128
  %add8890 = fadd double %rC.sroa.462.117059, %mul8887
  ...
  %add8910 = fadd double %287, %mul8907
  %302 = fmul double %rA.sroa.792.48.copyload, %rB.sroa.144.16.copyload14128
  %add8921 = fsub double %add8910, %302
  %mul8928 = fmul double %rA.sroa.675.48.copyload, %rB.sroa.144.16.copyload14128
  %add8931 = fadd double %rC.sroa.533.117060, %mul8928
  ...
  %add8951 = fadd double %286, %mul8948
  %303 = fmul double %rA.sroa.117.0.copyload14751, %rB.sroa.234.32.copyload14226
  %add8962 = fsub double %add8951, %303
  %mul8969 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.234.32.copyload14226
  %add8972 = fadd double %rC.sroa.604.117061, %mul8969
  ...
  %add8992 = fadd double %285, %mul8989
  %304 = fmul double %rA.sroa.342.16.copyload14991, %rB.sroa.234.32.copyload14226
  %add9003 = fsub double %add8992, %304
  %mul9010 = fmul double %rA.sroa.225.16.copyload14974, %rB.sroa.234.32.copyload14226
  %add9013 = fadd double %rC.sroa.675.117062, %mul9010
  ...
  %add9033 = fadd double %284, %mul9030
  %305 = fmul double %rA.sroa.567.32.copyload15240, %rB.sroa.234.32.copyload14226
  %add9044 = fsub double %add9033, %305
  %mul9051 = fmul double %rA.sroa.450.32.copyload15223, %rB.sroa.234.32.copyload14226
  %add9054 = fadd double %rC.sroa.746.117063, %mul9051
  ...
  %add9074 = fadd double %283, %mul9071
  %306 = fmul double %rA.sroa.792.48.copyload, %rB.sroa.234.32.copyload14226
  %add9085 = fsub double %add9074, %306
  %mul9092 = fmul double %rA.sroa.675.48.copyload, %rB.sroa.234.32.copyload14226
  %add9095 = fadd double %rC.sroa.817.117064, %mul9092
  ...
  %add9115 = fadd double %282, %mul9112
  %307 = fmul double %rA.sroa.117.0.copyload14751, %rB.sroa.324.48.copyload
  %add9126 = fsub double %add9115, %307
  %mul9133 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.324.48.copyload
  %add9136 = fadd double %rC.sroa.888.117065, %mul9133
  ...
  %add9156 = fadd double %281, %mul9153
  %308 = fmul double %rA.sroa.342.16.copyload14991, %rB.sroa.324.48.copyload
  %add9167 = fsub double %add9156, %308
  %mul9174 = fmul double %rA.sroa.225.16.copyload14974, %rB.sroa.324.48.copyload
  %add9177 = fadd double %rC.sroa.959.117066, %mul9174
  ...
  %add9197 = fadd double %280, %mul9194
  %309 = fmul double %rA.sroa.567.32.copyload15240, %rB.sroa.324.48.copyload
  %add9208 = fsub double %add9197, %309
  %mul9215 = fmul double %rA.sroa.450.32.copyload15223, %rB.sroa.324.48.copyload
  %add9218 = fadd double %rC.sroa.1030.117067, %mul9215
  ...
  %add9238 = fadd double %279, %mul9235
  %310 = fmul double %rA.sroa.792.48.copyload, %rB.sroa.324.48.copyload
  %add9249 = fsub double %add9238, %310
  %mul9256 = fmul double %rA.sroa.675.48.copyload, %rB.sroa.324.48.copyload
  %add9259 = fadd double %rC.sroa.1101.117068, %mul9256
  ...
  %add9279 = fadd double %278, %mul9276
  %311 = fmul double %rA.sroa.117.0.copyload14751, %rB.sroa.414.64.copyload14450
  %add9290 = fsub double %add9279, %311
  %mul9297 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.414.64.copyload14450
  %add9300 = fadd double %rC.sroa.1172.117069, %mul9297
  ...
  %add9320 = fadd double %277, %mul9317
  %312 = fmul double %rA.sroa.342.16.copyload14991, %rB.sroa.414.64.copyload14450
  %add9331 = fsub double %add9320, %312
  %mul9338 = fmul double %rA.sroa.225.16.copyload14974, %rB.sroa.414.64.copyload14450
  %add9341 = fadd double %rC.sroa.1243.117070, %mul9338
  ...
  %add9361 = fadd double %276, %mul9358
  %313 = fmul double %rA.sroa.567.32.copyload15240, %rB.sroa.414.64.copyload14450
  %add9372 = fsub double %add9361, %313
  %mul9379 = fmul double %rA.sroa.450.32.copyload15223, %rB.sroa.414.64.copyload14450
  %add9382 = fadd double %rC.sroa.1314.117071, %mul9379
  ...
  %add9402 = fadd double %275, %mul9399
  %314 = fmul double %rA.sroa.792.48.copyload, %rB.sroa.414.64.copyload14450
  %add9413 = fsub double %add9402, %314
  %mul9420 = fmul double %rA.sroa.675.48.copyload, %rB.sroa.414.64.copyload14450
  %add9423 = fadd double %rC.sroa.1385.117072, %mul9420
  ...
  %add9443 = fadd double %274, %mul9440
  %315 = fmul double %rA.sroa.117.0.copyload14751, %rB.sroa.504.80.copyload
  %add9454 = fsub double %add9443, %315
  %mul9461 = fmul double %rA.sroa.0.0.copyload14734, %rB.sroa.504.80.copyload
  %add9464 = fadd double %rC.sroa.1456.117073, %mul9461
  ...
  %add9484 = fadd double %273, %mul9481
  %316 = fmul double %rA.sroa.342.16.copyload14991, %rB.sroa.504.80.copyload
  %add9495 = fsub double %add9484, %316
  %mul9502 = fmul double %rA.sroa.225.16.copyload14974, %rB.sroa.504.80.copyload
  %add9505 = fadd double %rC.sroa.1527.117074, %mul9502
  ...
  %add9525 = fadd double %272, %mul9522
  %317 = fmul double %rA.sroa.567.32.copyload15240, %rB.sroa.504.80.copyload
  %add9536 = fsub double %add9525, %317
  %mul9543 = fmul double %rA.sroa.450.32.copyload15223, %rB.sroa.504.80.copyload
  %add9546 = fadd double %rC.sroa.1598.117075, %mul9543
  ...
  %add9566 = fadd double %271, %mul9563
  %318 = fmul double %rA.sroa.792.48.copyload, %rB.sroa.504.80.copyload
  %add9577 = fsub double %add9566, %318
  %mul9584 = fmul double %rA.sroa.675.48.copyload, %rB.sroa.504.80.copyload
  %add9587 = fadd double %rC.sroa.1669.117076, %mul9584
...
if.then9659:                                      ; preds = %if.then9629
  ...
  %325 = load double, double* %x9672, align 8, !tbaa !19
  %mul9673 = fmul double %beta.coerce.elt, %325
  ...
  %326 = load double, double* %y9691, align 8, !tbaa !21
  %mul9692 = fmul double %beta.coerce.elt, %326
...
if.end9698:                                       ; preds = %if.then9659, %if.then9629
  ...
  %cmp9700 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end9698.if.end9741_crit_edge:                  ; preds = %if.end9698
  %.pre17220 = zext i32 %rem25 to i64
  br label %if.end9741
...
if.then9701:                                      ; preds = %if.end9698
  ...
  %327 = load double, double* %y9715, align 8, !tbaa !21
  %328 = fmul double %beta.coerce.elt12916, %327
  %add9719 = fsub double %rC.sroa.0.2.in, %328
  %x9734 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add9713, i32 0
  %329 = load double, double* %x9734, align 8, !tbaa !19
  %mul9735 = fmul double %beta.coerce.elt12916, %329
  %add9738 = fadd double %rC.sroa.36.2, %mul9735
  br label %if.end9741

if.end9741:                                       ; preds = %if.then9701, %if.end9698.if.end9741_crit_edge
  %conv9749.pre-phi = phi i64 [ %.pre17220, %if.end9698.if.end9741_crit_edge ], [ %conv9710, %if.then9701 ]
  ...
  %330 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add9752, i32 0
  store double %rC.sroa.0.3.in, double* %330, align 8
...
if.end9755:                                       ; preds = %if.end9741, %if.end9612
  ...
  %331 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp9760 = icmp ult i32 %add9756, %331
  %or.cond16945 = and i1 %cmp9628, %cmp9760
  br i1 %or.cond16945, label %if.then9764, label %if.end9890

if.then9764:                                      ; preds = %if.end9755
  %mul9770 = fmul double %alpha.coerce.elt, %.lcssa17023
  %332 = fmul double %alpha.coerce.elt12914, %rC.sroa.107.1.lcssa
  %add9778 = fsub double %mul9770, %332
  %mul9784 = fmul double %alpha.coerce.elt, %rC.sroa.107.1.lcssa
  %mul9786 = fmul double %alpha.coerce.elt12914, %.lcssa17023
...
if.then9794:                                      ; preds = %if.then9764
  ...
  %333 = load double, double* %x9807, align 8, !tbaa !19
  %mul9808 = fmul double %beta.coerce.elt, %333
  ...
  %334 = load double, double* %y9826, align 8, !tbaa !21
  %mul9827 = fmul double %beta.coerce.elt, %334
...
if.end9833:                                       ; preds = %if.then9794, %if.then9764
  ...
  %cmp9835 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end9833.if.end9876_crit_edge:                  ; preds = %if.end9833
  %.pre17223 = zext i32 %rem25 to i64
  br label %if.end9876
...
if.then9836:                                      ; preds = %if.end9833
  ...
  %335 = load double, double* %y9850, align 8, !tbaa !21
  %336 = fmul double %beta.coerce.elt12916, %335
  %add9854 = fsub double %rC.sroa.71.2.in, %336
  %x9869 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add9848, i32 0
  %337 = load double, double* %x9869, align 8, !tbaa !19
  %mul9870 = fmul double %beta.coerce.elt12916, %337
  %add9873 = fadd double %rC.sroa.107.2, %mul9870
  br label %if.end9876

if.end9876:                                       ; preds = %if.then9836, %if.end9833.if.end9876_crit_edge
  %conv9884.pre-phi = phi i64 [ %.pre17223, %if.end9833.if.end9876_crit_edge ], [ %conv9845, %if.then9836 ]
  ...
  %338 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add9887, i32 0
  store double %rC.sroa.71.3.in, double* %338, align 8
...
if.end9890:                                       ; preds = %if.end9876, %if.end9755
  ...
  %339 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp9895 = icmp ult i32 %add9891, %339
  %or.cond16946 = and i1 %cmp9628, %cmp9895
  br i1 %or.cond16946, label %if.then9899, label %if.end10025

if.then9899:                                      ; preds = %if.end9890
  %mul9905 = fmul double %alpha.coerce.elt, %.lcssa17022
  %340 = fmul double %alpha.coerce.elt12914, %rC.sroa.178.1.lcssa
  %add9913 = fsub double %mul9905, %340
  %mul9919 = fmul double %alpha.coerce.elt, %rC.sroa.178.1.lcssa
  %mul9921 = fmul double %alpha.coerce.elt12914, %.lcssa17022
...
if.then9929:                                      ; preds = %if.then9899
  ...
  %341 = load double, double* %x9942, align 8, !tbaa !19
  %mul9943 = fmul double %beta.coerce.elt, %341
  ...
  %342 = load double, double* %y9961, align 8, !tbaa !21
  %mul9962 = fmul double %beta.coerce.elt, %342
...
if.end9968:                                       ; preds = %if.then9929, %if.then9899
  ...
  %cmp9970 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end9968.if.end10011_crit_edge:                 ; preds = %if.end9968
  %.pre17226 = zext i32 %rem25 to i64
...
if.then9971:                                      ; preds = %if.end9968
  ...
  %343 = load double, double* %y9985, align 8, !tbaa !21
  %344 = fmul double %beta.coerce.elt12916, %343
  %add9989 = fsub double %rC.sroa.142.2.in, %344
  %x10004 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add9983, i32 0
  %345 = load double, double* %x10004, align 8, !tbaa !19
  %mul10005 = fmul double %beta.coerce.elt12916, %345
  %add10008 = fadd double %rC.sroa.178.2, %mul10005
  br label %if.end10011

if.end10011:                                      ; preds = %if.then9971, %if.end9968.if.end10011_crit_edge
  %conv10019.pre-phi = phi i64 [ %.pre17226, %if.end9968.if.end10011_crit_edge ], [ %conv9980, %if.then9971 ]
  ...
  %346 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10022, i32 0
  store double %rC.sroa.142.3.in, double* %346, align 8
...
if.end10025:                                      ; preds = %if.end10011, %if.end9890
  ...
  %347 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10030 = icmp ult i32 %add10026, %347
  %or.cond16947 = and i1 %cmp9628, %cmp10030
  br i1 %or.cond16947, label %if.then10034, label %if.end10160

if.then10034:                                     ; preds = %if.end10025
  %mul10040 = fmul double %alpha.coerce.elt, %.lcssa17021
  %348 = fmul double %alpha.coerce.elt12914, %rC.sroa.249.1.lcssa
  %add10048 = fsub double %mul10040, %348
  %mul10054 = fmul double %alpha.coerce.elt, %rC.sroa.249.1.lcssa
  %mul10056 = fmul double %alpha.coerce.elt12914, %.lcssa17021
...
if.then10064:                                     ; preds = %if.then10034
  ...
  %349 = load double, double* %x10077, align 8, !tbaa !19
  %mul10078 = fmul double %beta.coerce.elt, %349
  ...
  %350 = load double, double* %y10096, align 8, !tbaa !21
  %mul10097 = fmul double %beta.coerce.elt, %350
...
if.end10103:                                      ; preds = %if.then10064, %if.then10034
  ...
  %cmp10105 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end10103.if.end10146_crit_edge:                ; preds = %if.end10103
  %.pre17229 = zext i32 %rem25 to i64
...
if.then10106:                                     ; preds = %if.end10103
  ...
  %351 = load double, double* %y10120, align 8, !tbaa !21
  %352 = fmul double %beta.coerce.elt12916, %351
  %add10124 = fsub double %rC.sroa.213.2.in, %352
  %x10139 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10118, i32 0
  %353 = load double, double* %x10139, align 8, !tbaa !19
  %mul10140 = fmul double %beta.coerce.elt12916, %353
  %add10143 = fadd double %rC.sroa.249.2, %mul10140
  br label %if.end10146

if.end10146:                                      ; preds = %if.then10106, %if.end10103.if.end10146_crit_edge
  %conv10154.pre-phi = phi i64 [ %.pre17229, %if.end10103.if.end10146_crit_edge ], [ %conv10115, %if.then10106 ]
  ...
  %354 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10157, i32 0
  store double %rC.sroa.213.3.in, double* %354, align 8
...
if.end10160:                                      ; preds = %if.end10146, %if.end10025
  ...
  %355 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10165 = icmp ult i32 %add9616, %355
  %cmp10168 = icmp ult i32 %add10163, %size1J
  %or.cond16948 = and i1 %cmp10168, %cmp10165
  br i1 %or.cond16948, label %if.then10169, label %if.end10295

if.then10169:                                     ; preds = %if.end10160
  %mul10175 = fmul double %alpha.coerce.elt, %.lcssa17020
  %356 = fmul double %alpha.coerce.elt12914, %rC.sroa.320.1.lcssa
  %add10183 = fsub double %mul10175, %356
  %mul10189 = fmul double %alpha.coerce.elt, %rC.sroa.320.1.lcssa
  %mul10191 = fmul double %alpha.coerce.elt12914, %.lcssa17020
...
if.then10199:                                     ; preds = %if.then10169
  ...
  %357 = load double, double* %x10212, align 8, !tbaa !19
  %mul10213 = fmul double %beta.coerce.elt, %357
  ...
  %358 = load double, double* %y10231, align 8, !tbaa !21
  %mul10232 = fmul double %beta.coerce.elt, %358
...
if.end10238:                                      ; preds = %if.then10199, %if.then10169
  ...
  %cmp10240 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end10238.if.end10281_crit_edge:                ; preds = %if.end10238
  %.pre17232 = zext i32 %rem25 to i64
...
if.then10241:                                     ; preds = %if.end10238
  ...
  %359 = load double, double* %y10255, align 8, !tbaa !21
  %360 = fmul double %beta.coerce.elt12916, %359
  %add10259 = fsub double %rC.sroa.284.2.in, %360
  %x10274 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10253, i32 0
  %361 = load double, double* %x10274, align 8, !tbaa !19
  %mul10275 = fmul double %beta.coerce.elt12916, %361
  %add10278 = fadd double %rC.sroa.320.2, %mul10275
  br label %if.end10281

if.end10281:                                      ; preds = %if.then10241, %if.end10238.if.end10281_crit_edge
  %conv10289.pre-phi = phi i64 [ %.pre17232, %if.end10238.if.end10281_crit_edge ], [ %conv10250, %if.then10241 ]
  ...
  %362 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10292, i32 0
  store double %rC.sroa.284.3.in, double* %362, align 8
...
if.end10295:                                      ; preds = %if.end10281, %if.end10160
  %363 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10300 = icmp ult i32 %add9756, %363
  %or.cond16949 = and i1 %cmp10168, %cmp10300
  br i1 %or.cond16949, label %if.then10304, label %if.end10430

if.then10304:                                     ; preds = %if.end10295
  %mul10310 = fmul double %alpha.coerce.elt, %.lcssa17019
  %364 = fmul double %alpha.coerce.elt12914, %rC.sroa.391.1.lcssa
  %add10318 = fsub double %mul10310, %364
  %mul10324 = fmul double %alpha.coerce.elt, %rC.sroa.391.1.lcssa
  %mul10326 = fmul double %alpha.coerce.elt12914, %.lcssa17019
...
if.then10334:                                     ; preds = %if.then10304
  ...
  %365 = load double, double* %x10347, align 8, !tbaa !19
  %mul10348 = fmul double %beta.coerce.elt, %365
  ...
  %366 = load double, double* %y10366, align 8, !tbaa !21
  %mul10367 = fmul double %beta.coerce.elt, %366
...
if.end10373:                                      ; preds = %if.then10334, %if.then10304
  ...
  %cmp10375 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end10373.if.end10416_crit_edge:                ; preds = %if.end10373
  %.pre17235 = zext i32 %rem25 to i64
...
if.then10376:                                     ; preds = %if.end10373
  ...
  %367 = load double, double* %y10390, align 8, !tbaa !21
  %368 = fmul double %beta.coerce.elt12916, %367
  %add10394 = fsub double %rC.sroa.355.2.in, %368
  %x10409 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10388, i32 0
  %369 = load double, double* %x10409, align 8, !tbaa !19
  %mul10410 = fmul double %beta.coerce.elt12916, %369
  %add10413 = fadd double %rC.sroa.391.2, %mul10410
  br label %if.end10416

if.end10416:                                      ; preds = %if.then10376, %if.end10373.if.end10416_crit_edge
  %conv10424.pre-phi = phi i64 [ %.pre17235, %if.end10373.if.end10416_crit_edge ], [ %conv10385, %if.then10376 ]
  ...
  %370 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10427, i32 0
  store double %rC.sroa.355.3.in, double* %370, align 8
...
if.end10430:                                      ; preds = %if.end10416, %if.end10295
  %371 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10435 = icmp ult i32 %add9891, %371
  %or.cond16950 = and i1 %cmp10168, %cmp10435
  br i1 %or.cond16950, label %if.then10439, label %if.end10565

if.then10439:                                     ; preds = %if.end10430
  %mul10445 = fmul double %alpha.coerce.elt, %.lcssa17018
  %372 = fmul double %alpha.coerce.elt12914, %rC.sroa.462.1.lcssa
  %add10453 = fsub double %mul10445, %372
  %mul10459 = fmul double %alpha.coerce.elt, %rC.sroa.462.1.lcssa
  %mul10461 = fmul double %alpha.coerce.elt12914, %.lcssa17018
...
if.then10469:                                     ; preds = %if.then10439
  ...
  %373 = load double, double* %x10482, align 8, !tbaa !19
  %mul10483 = fmul double %beta.coerce.elt, %373
  ...
  %374 = load double, double* %y10501, align 8, !tbaa !21
  %mul10502 = fmul double %beta.coerce.elt, %374
...
if.end10508:                                      ; preds = %if.then10469, %if.then10439
  ...
  %cmp10510 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end10508.if.end10551_crit_edge:                ; preds = %if.end10508
  %.pre17238 = zext i32 %rem25 to i64
...
if.then10511:                                     ; preds = %if.end10508
  ...
  %375 = load double, double* %y10525, align 8, !tbaa !21
  %376 = fmul double %beta.coerce.elt12916, %375
  %add10529 = fsub double %rC.sroa.426.2.in, %376
  %x10544 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10523, i32 0
  %377 = load double, double* %x10544, align 8, !tbaa !19
  %mul10545 = fmul double %beta.coerce.elt12916, %377
  %add10548 = fadd double %rC.sroa.462.2, %mul10545
  br label %if.end10551

if.end10551:                                      ; preds = %if.then10511, %if.end10508.if.end10551_crit_edge
  %conv10559.pre-phi = phi i64 [ %.pre17238, %if.end10508.if.end10551_crit_edge ], [ %conv10520, %if.then10511 ]
  ...
  %378 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10562, i32 0
  store double %rC.sroa.426.3.in, double* %378, align 8
...
if.end10565:                                      ; preds = %if.end10551, %if.end10430
  %379 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10570 = icmp ult i32 %add10026, %379
  %or.cond16951 = and i1 %cmp10168, %cmp10570
  br i1 %or.cond16951, label %if.then10574, label %if.end10700

if.then10574:                                     ; preds = %if.end10565
  %mul10580 = fmul double %alpha.coerce.elt, %.lcssa17017
  %380 = fmul double %alpha.coerce.elt12914, %rC.sroa.533.1.lcssa
  %add10588 = fsub double %mul10580, %380
  %mul10594 = fmul double %alpha.coerce.elt, %rC.sroa.533.1.lcssa
  %mul10596 = fmul double %alpha.coerce.elt12914, %.lcssa17017
...
if.then10604:                                     ; preds = %if.then10574
  ...
  %381 = load double, double* %x10617, align 8, !tbaa !19
  %mul10618 = fmul double %beta.coerce.elt, %381
  ...
  %382 = load double, double* %y10636, align 8, !tbaa !21
  %mul10637 = fmul double %beta.coerce.elt, %382
...
if.end10643:                                      ; preds = %if.then10604, %if.then10574
  ...
  %cmp10645 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.end10643.if.end10686_crit_edge:                ; preds = %if.end10643
  %.pre17241 = zext i32 %rem25 to i64
...
if.then10646:                                     ; preds = %if.end10643
  ...
  %383 = load double, double* %y10660, align 8, !tbaa !21
  %384 = fmul double %beta.coerce.elt12916, %383
  %add10664 = fsub double %rC.sroa.497.2.in, %384
  %x10679 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10658, i32 0
  %385 = load double, double* %x10679, align 8, !tbaa !19
  %mul10680 = fmul double %beta.coerce.elt12916, %385
  %add10683 = fadd double %rC.sroa.533.2, %mul10680
  br label %if.end10686

if.end10686:                                      ; preds = %if.then10646, %if.end10643.if.end10686_crit_edge
  %conv10694.pre-phi = phi i64 [ %.pre17241, %if.end10643.if.end10686_crit_edge ], [ %conv10655, %if.then10646 ]
  ...
  %386 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10697, i32 0
  store double %rC.sroa.497.3.in, double* %386, align 8
...
if.end10700:                                      ; preds = %if.end10686, %if.end10565
  ...
  %387 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10705 = icmp ult i32 %add9616, %387
  %cmp10708 = icmp ult i32 %add10703, %size1J
  %or.cond16952 = and i1 %cmp10708, %cmp10705
  br i1 %or.cond16952, label %if.then10709, label %if.end10835

if.then10709:                                     ; preds = %if.end10700
  %mul10715 = fmul double %alpha.coerce.elt, %.lcssa17016
  %388 = fmul double %alpha.coerce.elt12914, %rC.sroa.604.1.lcssa
  %add10723 = fsub double %mul10715, %388
  %mul10729 = fmul double %alpha.coerce.elt, %rC.sroa.604.1.lcssa
  %mul10731 = fmul double %alpha.coerce.elt12914, %.lcssa17016
...
if.then10739:                                     ; preds = %if.then10709
  ...
  %389 = load double, double* %x10752, align 8, !tbaa !19
  %mul10753 = fmul double %beta.coerce.elt, %389
  ...
  %390 = load double, double* %y10771, align 8, !tbaa !21
  %mul10772 = fmul double %beta.coerce.elt, %390
...
if.end10778:                                      ; preds = %if.then10739, %if.then10709
  ...
  %cmp10780 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then10781:                                     ; preds = %if.end10778
  ...
  %391 = load double, double* %y10795, align 8, !tbaa !21
  %392 = fmul double %beta.coerce.elt12916, %391
  %add10799 = fsub double %rC.sroa.568.2.in, %392
  %x10814 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10793, i32 0
  %393 = load double, double* %x10814, align 8, !tbaa !19
  %mul10815 = fmul double %beta.coerce.elt12916, %393
  %add10818 = fadd double %rC.sroa.604.2, %mul10815
  br label %if.end10821

if.end10821:                                      ; preds = %if.then10781, %if.end10778.if.end10821_crit_edge
  %conv10829.pre-phi = phi i64 [ %.pre17244, %if.end10778.if.end10821_crit_edge ], [ %conv10790, %if.then10781 ]
  ...
  %394 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10832, i32 0
  store double %rC.sroa.568.3.in, double* %394, align 8
...
if.end10835:                                      ; preds = %if.end10821, %if.end10700
  %395 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10840 = icmp ult i32 %add9756, %395
  %or.cond16953 = and i1 %cmp10708, %cmp10840
  br i1 %or.cond16953, label %if.then10844, label %if.end10970

if.then10844:                                     ; preds = %if.end10835
  %mul10850 = fmul double %alpha.coerce.elt, %.lcssa17015
  %396 = fmul double %alpha.coerce.elt12914, %rC.sroa.675.1.lcssa
  %add10858 = fsub double %mul10850, %396
  %mul10864 = fmul double %alpha.coerce.elt, %rC.sroa.675.1.lcssa
  %mul10866 = fmul double %alpha.coerce.elt12914, %.lcssa17015
...
if.then10874:                                     ; preds = %if.then10844
  ...
  %397 = load double, double* %x10887, align 8, !tbaa !19
  %mul10888 = fmul double %beta.coerce.elt, %397
  ...
  %398 = load double, double* %y10906, align 8, !tbaa !21
  %mul10907 = fmul double %beta.coerce.elt, %398
...
if.end10913:                                      ; preds = %if.then10874, %if.then10844
  ...
  %cmp10915 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then10916:                                     ; preds = %if.end10913
  ...
  %399 = load double, double* %y10930, align 8, !tbaa !21
  %400 = fmul double %beta.coerce.elt12916, %399
  %add10934 = fsub double %rC.sroa.639.2.in, %400
  %x10949 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add10928, i32 0
  %401 = load double, double* %x10949, align 8, !tbaa !19
  %mul10950 = fmul double %beta.coerce.elt12916, %401
  %add10953 = fadd double %rC.sroa.675.2, %mul10950
  br label %if.end10956

if.end10956:                                      ; preds = %if.then10916, %if.end10913.if.end10956_crit_edge
  %conv10964.pre-phi = phi i64 [ %.pre17247, %if.end10913.if.end10956_crit_edge ], [ %conv10925, %if.then10916 ]
  ...
  %402 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add10967, i32 0
  store double %rC.sroa.639.3.in, double* %402, align 8
...
if.end10970:                                      ; preds = %if.end10956, %if.end10835
  %403 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp10975 = icmp ult i32 %add9891, %403
  %or.cond16954 = and i1 %cmp10708, %cmp10975
  br i1 %or.cond16954, label %if.then10979, label %if.end11105

if.then10979:                                     ; preds = %if.end10970
  %mul10985 = fmul double %alpha.coerce.elt, %.lcssa17014
  %404 = fmul double %alpha.coerce.elt12914, %rC.sroa.746.1.lcssa
  %add10993 = fsub double %mul10985, %404
  %mul10999 = fmul double %alpha.coerce.elt, %rC.sroa.746.1.lcssa
  %mul11001 = fmul double %alpha.coerce.elt12914, %.lcssa17014
...
if.then11009:                                     ; preds = %if.then10979
  ...
  %405 = load double, double* %x11022, align 8, !tbaa !19
  %mul11023 = fmul double %beta.coerce.elt, %405
  ...
  %406 = load double, double* %y11041, align 8, !tbaa !21
  %mul11042 = fmul double %beta.coerce.elt, %406
...
if.end11048:                                      ; preds = %if.then11009, %if.then10979
  ...
  %cmp11050 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11051:                                     ; preds = %if.end11048
  ...
  %407 = load double, double* %y11065, align 8, !tbaa !21
  %408 = fmul double %beta.coerce.elt12916, %407
  %add11069 = fsub double %rC.sroa.710.2.in, %408
  %x11084 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11063, i32 0
  %409 = load double, double* %x11084, align 8, !tbaa !19
  %mul11085 = fmul double %beta.coerce.elt12916, %409
  %add11088 = fadd double %rC.sroa.746.2, %mul11085
  br label %if.end11091

if.end11091:                                      ; preds = %if.then11051, %if.end11048.if.end11091_crit_edge
  %conv11099.pre-phi = phi i64 [ %.pre17250, %if.end11048.if.end11091_crit_edge ], [ %conv11060, %if.then11051 ]
  ...
  %410 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11102, i32 0
  store double %rC.sroa.710.3.in, double* %410, align 8
...
if.end11105:                                      ; preds = %if.end11091, %if.end10970
  %411 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11110 = icmp ult i32 %add10026, %411
  %or.cond16955 = and i1 %cmp10708, %cmp11110
  br i1 %or.cond16955, label %if.then11114, label %if.end11240

if.then11114:                                     ; preds = %if.end11105
  %mul11120 = fmul double %alpha.coerce.elt, %.lcssa17013
  %412 = fmul double %alpha.coerce.elt12914, %rC.sroa.817.1.lcssa
  %add11128 = fsub double %mul11120, %412
  %mul11134 = fmul double %alpha.coerce.elt, %rC.sroa.817.1.lcssa
  %mul11136 = fmul double %alpha.coerce.elt12914, %.lcssa17013
...
if.then11144:                                     ; preds = %if.then11114
  ...
  %413 = load double, double* %x11157, align 8, !tbaa !19
  %mul11158 = fmul double %beta.coerce.elt, %413
  ...
  %414 = load double, double* %y11176, align 8, !tbaa !21
  %mul11177 = fmul double %beta.coerce.elt, %414
...
if.end11183:                                      ; preds = %if.then11144, %if.then11114
  ...
  %cmp11185 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11186:                                     ; preds = %if.end11183
  ...
  %415 = load double, double* %y11200, align 8, !tbaa !21
  %416 = fmul double %beta.coerce.elt12916, %415
  %add11204 = fsub double %rC.sroa.781.2.in, %416
  %x11219 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11198, i32 0
  %417 = load double, double* %x11219, align 8, !tbaa !19
  %mul11220 = fmul double %beta.coerce.elt12916, %417
  %add11223 = fadd double %rC.sroa.817.2, %mul11220
  br label %if.end11226

if.end11226:                                      ; preds = %if.then11186, %if.end11183.if.end11226_crit_edge
  %conv11234.pre-phi = phi i64 [ %.pre17253, %if.end11183.if.end11226_crit_edge ], [ %conv11195, %if.then11186 ]
  ...
  %418 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11237, i32 0
  store double %rC.sroa.781.3.in, double* %418, align 8
...
if.end11240:                                      ; preds = %if.end11226, %if.end11105
  ...
  %419 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11245 = icmp ult i32 %add9616, %419
  %cmp11248 = icmp ult i32 %add11243, %size1J
  %or.cond16956 = and i1 %cmp11248, %cmp11245
  br i1 %or.cond16956, label %if.then11249, label %if.end11375

if.then11249:                                     ; preds = %if.end11240
  %mul11255 = fmul double %alpha.coerce.elt, %.lcssa17012
  %420 = fmul double %alpha.coerce.elt12914, %rC.sroa.888.1.lcssa
  %add11263 = fsub double %mul11255, %420
  %mul11269 = fmul double %alpha.coerce.elt, %rC.sroa.888.1.lcssa
  %mul11271 = fmul double %alpha.coerce.elt12914, %.lcssa17012
...
if.then11279:                                     ; preds = %if.then11249
  ...
  %421 = load double, double* %x11292, align 8, !tbaa !19
  %mul11293 = fmul double %beta.coerce.elt, %421
  ...
  %422 = load double, double* %y11311, align 8, !tbaa !21
  %mul11312 = fmul double %beta.coerce.elt, %422
...
if.end11318:                                      ; preds = %if.then11279, %if.then11249
  ...
  %cmp11320 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11321:                                     ; preds = %if.end11318
  ...
  %423 = load double, double* %y11335, align 8, !tbaa !21
  %424 = fmul double %beta.coerce.elt12916, %423
  %add11339 = fsub double %rC.sroa.852.2.in, %424
  %x11354 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11333, i32 0
  %425 = load double, double* %x11354, align 8, !tbaa !19
  %mul11355 = fmul double %beta.coerce.elt12916, %425
  %add11358 = fadd double %rC.sroa.888.2, %mul11355
  br label %if.end11361

if.end11361:                                      ; preds = %if.then11321, %if.end11318.if.end11361_crit_edge
  %conv11369.pre-phi = phi i64 [ %.pre17256, %if.end11318.if.end11361_crit_edge ], [ %conv11330, %if.then11321 ]
  ...
  %426 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11372, i32 0
  store double %rC.sroa.852.3.in, double* %426, align 8
...
if.end11375:                                      ; preds = %if.end11361, %if.end11240
  %427 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11380 = icmp ult i32 %add9756, %427
  %or.cond16957 = and i1 %cmp11248, %cmp11380
  br i1 %or.cond16957, label %if.then11384, label %if.end11510

if.then11384:                                     ; preds = %if.end11375
  %mul11390 = fmul double %alpha.coerce.elt, %.lcssa17011
  %428 = fmul double %alpha.coerce.elt12914, %rC.sroa.959.1.lcssa
  %add11398 = fsub double %mul11390, %428
  %mul11404 = fmul double %alpha.coerce.elt, %rC.sroa.959.1.lcssa
  %mul11406 = fmul double %alpha.coerce.elt12914, %.lcssa17011
...
if.then11414:                                     ; preds = %if.then11384
  ...
  %429 = load double, double* %x11427, align 8, !tbaa !19
  %mul11428 = fmul double %beta.coerce.elt, %429
  ...
  %430 = load double, double* %y11446, align 8, !tbaa !21
  %mul11447 = fmul double %beta.coerce.elt, %430
...
if.end11453:                                      ; preds = %if.then11414, %if.then11384
  ...
  %cmp11455 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11456:                                     ; preds = %if.end11453
  ...
  %431 = load double, double* %y11470, align 8, !tbaa !21
  %432 = fmul double %beta.coerce.elt12916, %431
  %add11474 = fsub double %rC.sroa.923.2.in, %432
  %x11489 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11468, i32 0
  %433 = load double, double* %x11489, align 8, !tbaa !19
  %mul11490 = fmul double %beta.coerce.elt12916, %433
  %add11493 = fadd double %rC.sroa.959.2, %mul11490
  br label %if.end11496

if.end11496:                                      ; preds = %if.then11456, %if.end11453.if.end11496_crit_edge
  %conv11504.pre-phi = phi i64 [ %.pre17259, %if.end11453.if.end11496_crit_edge ], [ %conv11465, %if.then11456 ]
  ...
  %434 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11507, i32 0
  store double %rC.sroa.923.3.in, double* %434, align 8
...
if.end11510:                                      ; preds = %if.end11496, %if.end11375
  %435 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11515 = icmp ult i32 %add9891, %435
  %or.cond16958 = and i1 %cmp11248, %cmp11515
  br i1 %or.cond16958, label %if.then11519, label %if.end11645

if.then11519:                                     ; preds = %if.end11510
  %mul11525 = fmul double %alpha.coerce.elt, %.lcssa17010
  %436 = fmul double %alpha.coerce.elt12914, %rC.sroa.1030.1.lcssa
  %add11533 = fsub double %mul11525, %436
  %mul11539 = fmul double %alpha.coerce.elt, %rC.sroa.1030.1.lcssa
  %mul11541 = fmul double %alpha.coerce.elt12914, %.lcssa17010
...
if.then11549:                                     ; preds = %if.then11519
  ...
  %437 = load double, double* %x11562, align 8, !tbaa !19
  %mul11563 = fmul double %beta.coerce.elt, %437
  ...
  %438 = load double, double* %y11581, align 8, !tbaa !21
  %mul11582 = fmul double %beta.coerce.elt, %438
...
if.end11588:                                      ; preds = %if.then11549, %if.then11519
  ...
  %cmp11590 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11591:                                     ; preds = %if.end11588
  ...
  %439 = load double, double* %y11605, align 8, !tbaa !21
  %440 = fmul double %beta.coerce.elt12916, %439
  %add11609 = fsub double %rC.sroa.994.2.in, %440
  %x11624 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11603, i32 0
  %441 = load double, double* %x11624, align 8, !tbaa !19
  %mul11625 = fmul double %beta.coerce.elt12916, %441
  %add11628 = fadd double %rC.sroa.1030.2, %mul11625
  br label %if.end11631

if.end11631:                                      ; preds = %if.then11591, %if.end11588.if.end11631_crit_edge
  %conv11639.pre-phi = phi i64 [ %.pre17262, %if.end11588.if.end11631_crit_edge ], [ %conv11600, %if.then11591 ]
  ...
  %442 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11642, i32 0
  store double %rC.sroa.994.3.in, double* %442, align 8
...
if.end11645:                                      ; preds = %if.end11631, %if.end11510
  %443 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11650 = icmp ult i32 %add10026, %443
  %or.cond16959 = and i1 %cmp11248, %cmp11650
  br i1 %or.cond16959, label %if.then11654, label %if.end11780

if.then11654:                                     ; preds = %if.end11645
  %mul11660 = fmul double %alpha.coerce.elt, %.lcssa17009
  %444 = fmul double %alpha.coerce.elt12914, %rC.sroa.1101.1.lcssa
  %add11668 = fsub double %mul11660, %444
  %mul11674 = fmul double %alpha.coerce.elt, %rC.sroa.1101.1.lcssa
  %mul11676 = fmul double %alpha.coerce.elt12914, %.lcssa17009
...
if.then11684:                                     ; preds = %if.then11654
  ...
  %445 = load double, double* %x11697, align 8, !tbaa !19
  %mul11698 = fmul double %beta.coerce.elt, %445
  ...
  %446 = load double, double* %y11716, align 8, !tbaa !21
  %mul11717 = fmul double %beta.coerce.elt, %446
...
if.end11723:                                      ; preds = %if.then11684, %if.then11654
  ...
  %cmp11725 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11726:                                     ; preds = %if.end11723
  ...
  %447 = load double, double* %y11740, align 8, !tbaa !21
  %448 = fmul double %beta.coerce.elt12916, %447
  %add11744 = fsub double %rC.sroa.1065.2.in, %448
  %x11759 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11738, i32 0
  %449 = load double, double* %x11759, align 8, !tbaa !19
  %mul11760 = fmul double %beta.coerce.elt12916, %449
  %add11763 = fadd double %rC.sroa.1101.2, %mul11760
  br label %if.end11766

if.end11766:                                      ; preds = %if.then11726, %if.end11723.if.end11766_crit_edge
  %conv11774.pre-phi = phi i64 [ %.pre17265, %if.end11723.if.end11766_crit_edge ], [ %conv11735, %if.then11726 ]
  ...
  %450 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11777, i32 0
  store double %rC.sroa.1065.3.in, double* %450, align 8
...
if.end11780:                                      ; preds = %if.end11766, %if.end11645
  ...
  %451 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11785 = icmp ult i32 %add9616, %451
  %cmp11788 = icmp ult i32 %add11783, %size1J
  %or.cond16960 = and i1 %cmp11788, %cmp11785
  br i1 %or.cond16960, label %if.then11789, label %if.end11915

if.then11789:                                     ; preds = %if.end11780
  %mul11795 = fmul double %alpha.coerce.elt, %.lcssa17008
  %452 = fmul double %alpha.coerce.elt12914, %rC.sroa.1172.1.lcssa
  %add11803 = fsub double %mul11795, %452
  %mul11809 = fmul double %alpha.coerce.elt, %rC.sroa.1172.1.lcssa
  %mul11811 = fmul double %alpha.coerce.elt12914, %.lcssa17008
...
if.then11819:                                     ; preds = %if.then11789
  ...
  %453 = load double, double* %x11832, align 8, !tbaa !19
  %mul11833 = fmul double %beta.coerce.elt, %453
  ...
  %454 = load double, double* %y11851, align 8, !tbaa !21
  %mul11852 = fmul double %beta.coerce.elt, %454
...
if.end11858:                                      ; preds = %if.then11819, %if.then11789
  ...
  %cmp11860 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11861:                                     ; preds = %if.end11858
  ...
  %455 = load double, double* %y11875, align 8, !tbaa !21
  %456 = fmul double %beta.coerce.elt12916, %455
  %add11879 = fsub double %rC.sroa.1136.2.in, %456
  %x11894 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add11873, i32 0
  %457 = load double, double* %x11894, align 8, !tbaa !19
  %mul11895 = fmul double %beta.coerce.elt12916, %457
  %add11898 = fadd double %rC.sroa.1172.2, %mul11895
  br label %if.end11901

if.end11901:                                      ; preds = %if.then11861, %if.end11858.if.end11901_crit_edge
  %conv11909.pre-phi = phi i64 [ %.pre17268, %if.end11858.if.end11901_crit_edge ], [ %conv11870, %if.then11861 ]
  ...
  %458 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add11912, i32 0
  store double %rC.sroa.1136.3.in, double* %458, align 8
...
if.end11915:                                      ; preds = %if.end11901, %if.end11780
  %459 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp11920 = icmp ult i32 %add9756, %459
  %or.cond16961 = and i1 %cmp11788, %cmp11920
  br i1 %or.cond16961, label %if.then11924, label %if.end12050

if.then11924:                                     ; preds = %if.end11915
  %mul11930 = fmul double %alpha.coerce.elt, %.lcssa17007
  %460 = fmul double %alpha.coerce.elt12914, %rC.sroa.1243.1.lcssa
  %add11938 = fsub double %mul11930, %460
  %mul11944 = fmul double %alpha.coerce.elt, %rC.sroa.1243.1.lcssa
  %mul11946 = fmul double %alpha.coerce.elt12914, %.lcssa17007
...
if.then11954:                                     ; preds = %if.then11924
  ...
  %461 = load double, double* %x11967, align 8, !tbaa !19
  %mul11968 = fmul double %beta.coerce.elt, %461
  ...
  %462 = load double, double* %y11986, align 8, !tbaa !21
  %mul11987 = fmul double %beta.coerce.elt, %462
...
if.end11993:                                      ; preds = %if.then11954, %if.then11924
  ...
  %cmp11995 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then11996:                                     ; preds = %if.end11993
  ...
  %463 = load double, double* %y12010, align 8, !tbaa !21
  %464 = fmul double %beta.coerce.elt12916, %463
  %add12014 = fsub double %rC.sroa.1207.2.in, %464
  %x12029 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12008, i32 0
  %465 = load double, double* %x12029, align 8, !tbaa !19
  %mul12030 = fmul double %beta.coerce.elt12916, %465
  %add12033 = fadd double %rC.sroa.1243.2, %mul12030
  br label %if.end12036

if.end12036:                                      ; preds = %if.then11996, %if.end11993.if.end12036_crit_edge
  %conv12044.pre-phi = phi i64 [ %.pre17271, %if.end11993.if.end12036_crit_edge ], [ %conv12005, %if.then11996 ]
  ...
  %466 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12047, i32 0
  store double %rC.sroa.1207.3.in, double* %466, align 8
...
if.end12050:                                      ; preds = %if.end12036, %if.end11915
  %467 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp12055 = icmp ult i32 %add9891, %467
  %or.cond16962 = and i1 %cmp11788, %cmp12055
  br i1 %or.cond16962, label %if.then12059, label %if.end12185

if.then12059:                                     ; preds = %if.end12050
  %mul12065 = fmul double %alpha.coerce.elt, %.lcssa17006
  %468 = fmul double %alpha.coerce.elt12914, %rC.sroa.1314.1.lcssa
  %add12073 = fsub double %mul12065, %468
  %mul12079 = fmul double %alpha.coerce.elt, %rC.sroa.1314.1.lcssa
  %mul12081 = fmul double %alpha.coerce.elt12914, %.lcssa17006
...
if.then12089:                                     ; preds = %if.then12059
  ...
  %469 = load double, double* %x12102, align 8, !tbaa !19
  %mul12103 = fmul double %beta.coerce.elt, %469
  ...
  %470 = load double, double* %y12121, align 8, !tbaa !21
  %mul12122 = fmul double %beta.coerce.elt, %470
...
if.end12128:                                      ; preds = %if.then12089, %if.then12059
  ...
  %cmp12130 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then12131:                                     ; preds = %if.end12128
  ...
  %471 = load double, double* %y12145, align 8, !tbaa !21
  %472 = fmul double %beta.coerce.elt12916, %471
  %add12149 = fsub double %rC.sroa.1278.2.in, %472
  %x12164 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12143, i32 0
  %473 = load double, double* %x12164, align 8, !tbaa !19
  %mul12165 = fmul double %beta.coerce.elt12916, %473
  %add12168 = fadd double %rC.sroa.1314.2, %mul12165
  br label %if.end12171

if.end12171:                                      ; preds = %if.then12131, %if.end12128.if.end12171_crit_edge
  %conv12179.pre-phi = phi i64 [ %.pre17274, %if.end12128.if.end12171_crit_edge ], [ %conv12140, %if.then12131 ]
  ...
  %474 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12182, i32 0
  store double %rC.sroa.1278.3.in, double* %474, align 8
...
if.end12185:                                      ; preds = %if.end12171, %if.end12050
  %475 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp12190 = icmp ult i32 %add10026, %475
  %or.cond16963 = and i1 %cmp11788, %cmp12190
  br i1 %or.cond16963, label %if.then12194, label %if.end12320

if.then12194:                                     ; preds = %if.end12185
  %mul12200 = fmul double %alpha.coerce.elt, %.lcssa17005
  %476 = fmul double %alpha.coerce.elt12914, %rC.sroa.1385.1.lcssa
  %add12208 = fsub double %mul12200, %476
  %mul12214 = fmul double %alpha.coerce.elt, %rC.sroa.1385.1.lcssa
  %mul12216 = fmul double %alpha.coerce.elt12914, %.lcssa17005
...
if.then12224:                                     ; preds = %if.then12194
  ...
  %477 = load double, double* %x12237, align 8, !tbaa !19
  %mul12238 = fmul double %beta.coerce.elt, %477
  ...
  %478 = load double, double* %y12256, align 8, !tbaa !21
  %mul12257 = fmul double %beta.coerce.elt, %478
...
if.end12263:                                      ; preds = %if.then12224, %if.then12194
  ...
  %cmp12265 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then12266:                                     ; preds = %if.end12263
  ...
  %479 = load double, double* %y12280, align 8, !tbaa !21
  %480 = fmul double %beta.coerce.elt12916, %479
  %add12284 = fsub double %rC.sroa.1349.2.in, %480
  %x12299 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12278, i32 0
  %481 = load double, double* %x12299, align 8, !tbaa !19
  %mul12300 = fmul double %beta.coerce.elt12916, %481
  %add12303 = fadd double %rC.sroa.1385.2, %mul12300
  br label %if.end12306

if.end12306:                                      ; preds = %if.then12266, %if.end12263.if.end12306_crit_edge
  %conv12314.pre-phi = phi i64 [ %.pre17277, %if.end12263.if.end12306_crit_edge ], [ %conv12275, %if.then12266 ]
  ...
  %482 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12317, i32 0
  store double %rC.sroa.1349.3.in, double* %482, align 8
...
if.end12320:                                      ; preds = %if.end12306, %if.end12185
  ...
  %483 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp12325 = icmp ult i32 %add9616, %483
  %cmp12328 = icmp ult i32 %add12323, %size1J
  %or.cond16964 = and i1 %cmp12328, %cmp12325
  br i1 %or.cond16964, label %if.then12329, label %if.end12455

if.then12329:                                     ; preds = %if.end12320
  %mul12335 = fmul double %alpha.coerce.elt, %.lcssa17004
  %484 = fmul double %alpha.coerce.elt12914, %rC.sroa.1456.1.lcssa
  %add12343 = fsub double %mul12335, %484
  %mul12349 = fmul double %alpha.coerce.elt, %rC.sroa.1456.1.lcssa
  %mul12351 = fmul double %alpha.coerce.elt12914, %.lcssa17004
...
if.then12359:                                     ; preds = %if.then12329
  ...
  %485 = load double, double* %x12372, align 8, !tbaa !19
  %mul12373 = fmul double %beta.coerce.elt, %485
  ...
  %486 = load double, double* %y12391, align 8, !tbaa !21
  %mul12392 = fmul double %beta.coerce.elt, %486
...
if.end12398:                                      ; preds = %if.then12359, %if.then12329
  ...
  %cmp12400 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then12401:                                     ; preds = %if.end12398
  ...
  %487 = load double, double* %y12415, align 8, !tbaa !21
  %488 = fmul double %beta.coerce.elt12916, %487
  %add12419 = fsub double %rC.sroa.1420.2.in, %488
  %x12434 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12413, i32 0
  %489 = load double, double* %x12434, align 8, !tbaa !19
  %mul12435 = fmul double %beta.coerce.elt12916, %489
  %add12438 = fadd double %rC.sroa.1456.2, %mul12435
  br label %if.end12441

if.end12441:                                      ; preds = %if.then12401, %if.end12398.if.end12441_crit_edge
  %conv12449.pre-phi = phi i64 [ %.pre17280, %if.end12398.if.end12441_crit_edge ], [ %conv12410, %if.then12401 ]
  ...
  %490 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12452, i32 0
  store double %rC.sroa.1420.3.in, double* %490, align 8
...
if.end12455:                                      ; preds = %if.end12441, %if.end12320
  %491 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp12460 = icmp ult i32 %add9756, %491
  %or.cond16965 = and i1 %cmp12328, %cmp12460
  br i1 %or.cond16965, label %if.then12464, label %if.end12590

if.then12464:                                     ; preds = %if.end12455
  %mul12470 = fmul double %alpha.coerce.elt, %.lcssa17003
  %492 = fmul double %alpha.coerce.elt12914, %rC.sroa.1527.1.lcssa
  %add12478 = fsub double %mul12470, %492
  %mul12484 = fmul double %alpha.coerce.elt, %rC.sroa.1527.1.lcssa
  %mul12486 = fmul double %alpha.coerce.elt12914, %.lcssa17003
...
if.then12494:                                     ; preds = %if.then12464
  ...
  %493 = load double, double* %x12507, align 8, !tbaa !19
  %mul12508 = fmul double %beta.coerce.elt, %493
  ...
  %494 = load double, double* %y12526, align 8, !tbaa !21
  %mul12527 = fmul double %beta.coerce.elt, %494
...
if.end12533:                                      ; preds = %if.then12494, %if.then12464
  ...
  %cmp12535 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then12536:                                     ; preds = %if.end12533
  ...
  %495 = load double, double* %y12550, align 8, !tbaa !21
  %496 = fmul double %beta.coerce.elt12916, %495
  %add12554 = fsub double %rC.sroa.1491.2.in, %496
  %x12569 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12548, i32 0
  %497 = load double, double* %x12569, align 8, !tbaa !19
  %mul12570 = fmul double %beta.coerce.elt12916, %497
  %add12573 = fadd double %rC.sroa.1527.2, %mul12570
  br label %if.end12576

if.end12576:                                      ; preds = %if.then12536, %if.end12533.if.end12576_crit_edge
  %conv12584.pre-phi = phi i64 [ %.pre17283, %if.end12533.if.end12576_crit_edge ], [ %conv12545, %if.then12536 ]
  ...
  %498 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12587, i32 0
  store double %rC.sroa.1491.3.in, double* %498, align 8
...
if.end12590:                                      ; preds = %if.end12576, %if.end12455
  %499 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp12595 = icmp ult i32 %add9891, %499
  %or.cond16966 = and i1 %cmp12328, %cmp12595
  br i1 %or.cond16966, label %if.then12599, label %if.end12725

if.then12599:                                     ; preds = %if.end12590
  %mul12605 = fmul double %alpha.coerce.elt, %.lcssa17002
  %500 = fmul double %alpha.coerce.elt12914, %rC.sroa.1598.1.lcssa
  %add12613 = fsub double %mul12605, %500
  %mul12619 = fmul double %alpha.coerce.elt, %rC.sroa.1598.1.lcssa
  %mul12621 = fmul double %alpha.coerce.elt12914, %.lcssa17002
...
if.then12629:                                     ; preds = %if.then12599
  ...
  %501 = load double, double* %x12642, align 8, !tbaa !19
  %mul12643 = fmul double %beta.coerce.elt, %501
  ...
  %502 = load double, double* %y12661, align 8, !tbaa !21
  %mul12662 = fmul double %beta.coerce.elt, %502
...
if.end12668:                                      ; preds = %if.then12629, %if.then12599
  ...
  %cmp12670 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then12671:                                     ; preds = %if.end12668
  ...
  %503 = load double, double* %y12685, align 8, !tbaa !21
  %504 = fmul double %beta.coerce.elt12916, %503
  %add12689 = fsub double %rC.sroa.1562.2.in, %504
  %x12704 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12683, i32 0
  %505 = load double, double* %x12704, align 8, !tbaa !19
  %mul12705 = fmul double %beta.coerce.elt12916, %505
  %add12708 = fadd double %rC.sroa.1598.2, %mul12705
  br label %if.end12711

if.end12711:                                      ; preds = %if.then12671, %if.end12668.if.end12711_crit_edge
  %conv12719.pre-phi = phi i64 [ %.pre17286, %if.end12668.if.end12711_crit_edge ], [ %conv12680, %if.then12671 ]
  ...
  %506 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12722, i32 0
  store double %rC.sroa.1562.3.in, double* %506, align 8
...
if.end12725:                                      ; preds = %if.end12711, %if.end12590
  %507 = load volatile i32, i32* %0, align 4, !tbaa !8
  %cmp12730 = icmp ult i32 %add10026, %507
  %or.cond16967 = and i1 %cmp12328, %cmp12730
  br i1 %or.cond16967, label %if.then12734, label %if.end12860

if.then12734:                                     ; preds = %if.end12725
  %mul12740 = fmul double %alpha.coerce.elt, %.lcssa
  %508 = fmul double %alpha.coerce.elt12914, %rC.sroa.1669.1.lcssa
  %add12748 = fsub double %mul12740, %508
  %mul12754 = fmul double %alpha.coerce.elt, %rC.sroa.1669.1.lcssa
  %mul12756 = fmul double %alpha.coerce.elt12914, %.lcssa
...
if.then12764:                                     ; preds = %if.then12734
  ...
  %509 = load double, double* %x12777, align 8, !tbaa !19
  %mul12778 = fmul double %beta.coerce.elt, %509
  ...
  %510 = load double, double* %y12796, align 8, !tbaa !21
  %mul12797 = fmul double %beta.coerce.elt, %510
...
if.end12803:                                      ; preds = %if.then12764, %if.then12734
  ...
  %cmp12805 = fcmp une double %beta.coerce.elt12916, 0.000000e+00
...
if.then12806:                                     ; preds = %if.end12803
  ...
  %511 = load double, double* %y12820, align 8, !tbaa !21
  %512 = fmul double %beta.coerce.elt12916, %511
  %add12824 = fsub double %rC.sroa.1633.2.in, %512
  %x12839 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %C, i64 %add12818, i32 0
  %513 = load double, double* %x12839, align 8, !tbaa !19
  %mul12840 = fmul double %beta.coerce.elt12916, %513
  %add12843 = fadd double %rC.sroa.1669.2, %mul12840
  br label %if.end12846

if.end12846:                                      ; preds = %if.then12806, %if.end12803.if.end12846_crit_edge
  %conv12854.pre-phi = phi i64 [ %.pre17289, %if.end12803.if.end12846_crit_edge ], [ %conv12815, %if.then12806 ]
  ...
  %514 = getelementptr inbounds %struct.tensile_complex, %struct.tensile_complex* %D, i64 %add12857, i32 0
  store double %rC.sroa.1633.3.in, double* %514, align 8
