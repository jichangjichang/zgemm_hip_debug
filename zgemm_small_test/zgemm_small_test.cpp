...
#define SCALAR_OOB_DATA SCALAR_ZERO
  ...
  unsigned int globalReadOffsetB1J_1_0 = globalReadOffsetB1J + 0 + 1*LSCB;
  unsigned int globalReadOffsetB1J_2_0 = globalReadOffsetB1J + 0 + 2*LSCB;
  ...
  globalReadOffsetB1J_1_0 = (  globalReadOffsetB1J_1_0 > size1J-GLOBAL_LOAD_VECTOR_WIDTH_B+0) ? size1J-GLOBAL_LOAD_VECTOR_WIDTH_B+0 : globalReadOffsetB1J_1_0;
  globalReadOffsetB1J_2_0 = (  globalReadOffsetB1J_2_0 > size1J-GLOBAL_LOAD_VECTOR_WIDTH_B+0) ? size1J-GLOBAL_LOAD_VECTOR_WIDTH_B+0 : globalReadOffsetB1J_2_0;
  ...
  uint64_t globalReadOffsetB_1_0_0_0 = GLOBAL_OFFSET_B( globalReadOffsetB1J_1_0, globalReadOffsetBL_0_0, wgK );
  uint64_t globalReadOffsetB_2_0_0_0 = GLOBAL_OFFSET_B( globalReadOffsetB1J_2_0, globalReadOffsetBL_0_0, wgK );
  uint64_t globalReadOffsetB_0_0_1_0 = GLOBAL_OFFSET_B( globalReadOffsetB1J_0_0, globalReadOffsetBL_1_0, wgK );
  uint64_t globalReadOffsetB_1_0_1_0 = GLOBAL_OFFSET_B( globalReadOffsetB1J_1_0, globalReadOffsetBL_1_0, wgK );
  uint64_t globalReadOffsetB_2_0_1_0 = GLOBAL_OFFSET_B( globalReadOffsetB1J_2_0, globalReadOffsetBL_1_0, wgK );
  ...
  DATA_TYPE const *globalReadB_1_0_0_0 = B + globalReadOffsetB_1_0_0_0;
  DATA_TYPE const *globalReadB_2_0_0_0 = B + globalReadOffsetB_2_0_0_0;
  DATA_TYPE const *globalReadB_0_0_1_0 = B + globalReadOffsetB_0_0_1_0;
  DATA_TYPE const *globalReadB_1_0_1_0 = B + globalReadOffsetB_1_0_1_0;
  DATA_TYPE const *globalReadB_2_0_1_0 = B + globalReadOffsetB_2_0_1_0;
  ...
  unsigned int localWriteOffsetB_1_0_0_0 = localWriteFirstOffsetB + (0 + 1*LSCB) + (0 + 0*LSPB)*(MT1J+PAD);
  unsigned int localWriteOffsetB_2_0_0_0 = localWriteFirstOffsetB + (0 + 2*LSCB) + (0 + 0*LSPB)*(MT1J+PAD);
  unsigned int localWriteOffsetB_0_0_1_0 = localWriteFirstOffsetB + (0 + 0*LSCB) + (0 + 1*LSPB)*(MT1J+PAD);
  unsigned int localWriteOffsetB_1_0_1_0 = localWriteFirstOffsetB + (0 + 1*LSCB) + (0 + 1*LSPB)*(MT1J+PAD);
  unsigned int localWriteOffsetB_2_0_1_0 = localWriteFirstOffsetB + (0 + 2*LSCB) + (0 + 1*LSPB)*(MT1J+PAD);
  ...
  DATA_TYPE *localWriteB_1_0_0_0;
  DATA_TYPE *localWriteB_2_0_0_0;
  DATA_TYPE *localWriteB_0_0_1_0;
  DATA_TYPE *localWriteB_1_0_1_0;
  DATA_TYPE *localWriteB_2_0_1_0;
  ...
  localWriteB_1_0_0_0 = (DATA_TYPE *)(localMemory + localWriteOffsetB_1_0_0_0);
  localWriteB_2_0_0_0 = (DATA_TYPE *)(localMemory + localWriteOffsetB_2_0_0_0);
  localWriteB_0_0_1_0 = (DATA_TYPE *)(localMemory + localWriteOffsetB_0_0_1_0);
  localWriteB_1_0_1_0 = (DATA_TYPE *)(localMemory + localWriteOffsetB_1_0_1_0);
  localWriteB_2_0_1_0 = (DATA_TYPE *)(localMemory + localWriteOffsetB_2_0_1_0);
  ...
  globalReadB_1_0_0_0 += (staggerUIter * globalReadIncBL); // apply stagger offset
  globalReadB_2_0_0_0 += (staggerUIter * globalReadIncBL); // apply stagger offset
  globalReadB_0_0_1_0 += (staggerUIter * globalReadIncBL); // apply stagger offset
  globalReadB_1_0_1_0 += (staggerUIter * globalReadIncBL); // apply stagger offset
  globalReadB_2_0_1_0 += (staggerUIter * globalReadIncBL); // apply stagger offset
  ...
  while (numIterL-- > 0) {
    ...
    b_1_0_0_0 = *(globalReadB_1_0_0_0 + 0);
    b_2_0_0_0 = *(globalReadB_2_0_0_0 + 0);
    b_0_0_1_0 = *(globalReadB_0_0_1_0 + 0);
    b_1_0_1_0 = *(globalReadB_1_0_1_0 + 0);
    b_2_0_1_0 = *(globalReadB_2_0_1_0 + 0);
    ...
    globalReadB_1_0_0_0 = (DATA_TYPE const *)( ((DATA_TYPE const *)globalReadB_1_0_0_0) + globalReadIncBL);
    if ((numIterL) == staggerUIter) {
      globalReadB_1_0_0_0 -= (origNumIter * globalReadIncBL); // wrap staggered offset back to row start
    }
    globalReadB_2_0_0_0 = (DATA_TYPE const *)( ((DATA_TYPE const *)globalReadB_2_0_0_0) + globalReadIncBL);
    if ((numIterL) == staggerUIter) {
      globalReadB_2_0_0_0 -= (origNumIter * globalReadIncBL); // wrap staggered offset back to row start
    }
    ...
    globalReadB_1_0_1_0 = (DATA_TYPE const *)( ((DATA_TYPE const *)globalReadB_1_0_1_0) + globalReadIncBL);
    if ((numIterL) == staggerUIter) {
      globalReadB_1_0_1_0 -= (origNumIter * globalReadIncBL); // wrap staggered offset back to row start
    }
    globalReadB_2_0_1_0 = (DATA_TYPE const *)( ((DATA_TYPE const *)globalReadB_2_0_1_0) + globalReadIncBL);
    if ((numIterL) == staggerUIter) {
      globalReadB_2_0_1_0 -= (origNumIter * globalReadIncBL); // wrap staggered offset back to row start
    }
...
#pragma clang diagnostic ignored "-Wconditional-uninitialized"
    ...
    *(localWriteB_1_0_0_0 + 0) = b_1_0_0_0;
    *(localWriteB_2_0_0_0 + 0) = b_2_0_0_0;
    *(localWriteB_0_0_1_0 + 0) = b_0_0_1_0;
    *(localWriteB_1_0_1_0 + 0) = b_1_0_1_0;
    *(localWriteB_2_0_1_0 + 0) = b_2_0_1_0;
#pragma clang diagnostic pop
  ...
  globalReadB_1_0_0_0 += ((origNumIter - (staggerUIter - 0)) * globalReadIncBL); // remove stagger offset
  globalReadB_2_0_0_0 += ((origNumIter - (staggerUIter - 0)) * globalReadIncBL); // remove stagger offset
  globalReadB_0_0_1_0 += ((origNumIter - (staggerUIter - 0)) * globalReadIncBL); // remove stagger offset
  globalReadB_1_0_1_0 += ((origNumIter - (staggerUIter - 0)) * globalReadIncBL); // remove stagger offset
  globalReadB_2_0_1_0 += ((origNumIter - (staggerUIter - 0)) * globalReadIncBL); // remove stagger offset
  ...
  b_1_0_0_0 = ( globalReadOffsetBL_0_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_OOB_DATA : *(globalReadB_1_0_0_0 + 0);
  b_2_0_0_0 = ( globalReadOffsetBL_0_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_OOB_DATA : *(globalReadB_2_0_0_0 + 0);
  b_0_0_1_0 = ( globalReadOffsetBL_1_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_OOB_DATA : *(globalReadB_0_0_1_0 + 0);
  b_1_0_1_0 = ( globalReadOffsetBL_1_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_OOB_DATA : *(globalReadB_1_0_1_0 + 0);
  b_2_0_1_0 = ( globalReadOffsetBL_1_0 + 0 >= (sizeL % LOCAL_DEPTHU) ) ? SCALAR_OOB_DATA : *(globalReadB_2_0_1_0 + 0);
